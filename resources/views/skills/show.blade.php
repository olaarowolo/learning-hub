...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-md-4">
            <img src="{{ $course->image_url }}" alt="Skill image for {{ $course->title }}" class="img-fluid rounded" style="max-height: 200px; width: 100%; object-fit: cover;">
        </div>
    </div>
    ...
    @if ($course->progress > 0)
        ...
        <a href="#" class="btn btn-success btn-block">Continue Skill</a>
    @else
        <a href="#" class="btn btn-primary btn-block mt-auto">Start Skill</a>
    @endif
