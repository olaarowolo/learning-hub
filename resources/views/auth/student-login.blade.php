...
@section('content')
@include('partials.breadcrumb', ['title' => 'Student Login'])

<div class="container my-5">
    <header class="text-center">
        <h1>Student Login</h1>
        <p>Welcome back, Student! Access your Learning Hub</p>
    </header>
    ...
    <main>
        <div class="terms-content">
            ...
            <div class="text-center mt-3">
                <p>Are you a tutor? <a href="{{ route('tutor.login') }}">Login as Tutor</a></p>
