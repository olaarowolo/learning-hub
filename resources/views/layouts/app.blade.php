              ...
              <ul>
                ...
                <li class="menu-item sub-menu">
                  ...
                  <div class="sub-menu-list">
                    <ul>
                      <li class="menu-item sub-menu">
                        <a href="#"><span class="menu-title">Early Years Foundation Stage (EYFS)</span></a>
                        <div class="sub-menu-list">
                          <ul>
                            <li class="menu-item"><a href="{{ url('/data/yeargroups/KS0/y0/yr0-index.html') }}"><span class="menu-title">Pre-School Ideas</span></a></li>
                            <li class="menu-item"><a href="{{ url('/data/yeargroups/EYFS/y0/yrR-index.html') }}"><span class="menu-title">Reception</span></a></li>
                          </ul>
                        </div>
                      </li>
                      <li class="menu-item sub-menu">
