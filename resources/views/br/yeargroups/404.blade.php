...
<style>
/* Modal and full-page background styles */
body {
...
/* Styles for the content inside the modal (your error-container) */
.error-container {
    ...
    /* Removed the centering properties since the modal wrapper now handles it */
}
...
<body>
    ...
    <div id="modal-content" class="modal-content">
        <div id="error-container" class="error-container">
            ...
            <div id="error-emoji" class="emoji">🤖</div>
            <p id="error-message-1">Looks like our robot friend got lost! This part of the app is still under construction. 🚀</p>
            <p id="error-message-2">We're building the platform week by week, with new content and features added progressively to match what we're teaching our current students.</p>
            <p id="error-message-3">The app is a live reflection of the material we are currently teaching. Stay tuned for updates as we continue to build and grow!</p>
            <a id="home-link" href="{{ route('home') }}">← Back to Home</a>
        </div>
    </div>
</div>
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (errorModal) {
      errorModal.style.display = 'flex'; // Use 'flex' to activate the centering styles
    }
  });
</script>
