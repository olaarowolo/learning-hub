...
<head>
    ...
    <title>Week 1 - Autumn Term - Early Maths</title>
...
<body>
    <header class="year-header">
        <h1>Week 1 - Autumn Term</h1>
        <a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/index.html" class="back-link">← Back to Autumn Term</a>
    </header>
    <main>
        <h2>Week 1: Counting up to 3</h2>
        <p><strong>Focus:</strong> Counting up to 3</p>
        <p><strong>Activities:</strong> Count objects (toys, fingers), number songs</p>
        <p><strong>Resources:</strong> Small toys, fingers, counting rhymes</p>
        <p><strong>Vocabulary:</strong> one, two, three, count</p>
        <p>Add detailed content, videos, exercises <a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/activities/counting-to-3.html">on this page</a> here.</p>
    </main>
    <footer>
