...
<head>
    ...
    <title>Week 2 - Autumn Term - Early Maths</title>
...
<body>
    <header class="year-header">
        <h1>Week 2 - Autumn Term</h1>
        <a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/index.html" class="back-link">← Back to Autumn Term</a>
    </header>
    <main>
        <h2>Week 2: Counting up to 5</h2>
        <p><strong>Focus:</strong> Counting up to 5</p>
        <p><strong>Activities:</strong> Match numerals 0–5 to objects; sorting into sets</p>
        <p><strong>Resources:</strong> Number cards 0–5, everyday objects</p>
        <p><strong>Vocabulary:</strong> more, less, same</p>
        <p>Add detailed content, videos, exercises here.</p>
    </main>
    <footer>
