...
<head>
    ...
    <title>Early Maths - Reception</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            ...
            <span>EYFS</span> >
            <a href="/data/yeargroups/EYFS/y0/yrR-index.html">Reception</a> >
            <span>Maths</span>
        </nav>
        <h1>Early Maths - Reception</h1>
        <a href="/data/yeargroups/eyfs/y0/yrR-index.html" class="back-link">← Back to Reception Home</a>
    </header>
    <main>
        <h2>Welcome to Reception Early Maths!</h2>
        <p>This page contains the 12-week Early Maths plan for Reception.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/eyfs/y0/subjects/maths/EYFS-y0-ma-curriculum-plan.html">Reception Early Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/index.html">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/spring/index.html">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/summer/index.html">Summer Term</a></li>
        </ul>
    </main>
    <footer>
