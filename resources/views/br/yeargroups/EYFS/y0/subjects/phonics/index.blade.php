...
<body>
    <header class="year-header">
        <h1>Phonics - Reception</h1>
        <a href="/data/yeargroups/EYFS/y0/subjects/yrR-index.html" class="back-link">← Back to Reception Home</a>
    </header>
    <main>
        <h2>Welcome to Reception Early Phonics!</h2>
        <p>This page contains the 12-week Early Phonics plan for Reception.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/EYFS/y0/subjects/phonics/EYFS-y0-phonics-curriculum-plan.html">Reception Early Phonics Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/EYFS/y0/subjects/phonics/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/phonics/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/phonics/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
