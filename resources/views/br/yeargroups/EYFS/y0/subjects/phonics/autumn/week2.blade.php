...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 2</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 2</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Shapes and Patterns</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week focuses on recognizing basic shapes and understanding simple patterns. Shapes are everywhere around us, and patterns help us see order and repetition.</p>
                <p>Children will learn to identify shapes like circles, squares, and triangles, and create simple patterns using colors or objects.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Practice identifying shapes in everyday objects. Create patterns using blocks, beads, or drawings.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Shapes and Patterns</h3>
                <p>Shapes are the form of objects. Basic shapes include circles, squares, triangles, and rectangles.</p>
                <ul>
                    <li>Circle: Round like a ball.</li>
                    <li>Square: Four equal sides, like a box.</li>
                    <li>Triangle: Three sides, like a pizza slice.</li>
                    <li>Rectangle: Four sides, longer than wide.</li>
                </ul>

                <h4>🔹 Recognizing Shapes</h4>
                <p>Look for shapes in your environment. Point out shapes in pictures or real objects.</p>
                <p>Examples:</p>
                <ul>
                    <li>A clock is a circle.</li>
                    <li>A book is a rectangle.</li>
                    <li>A roof can be a triangle.</li>
                </ul>

                <h4>🔹 Simple Patterns</h4>
                <p>Patterns repeat in a sequence. Use colors, shapes, or objects to make patterns.</p>
                <p>Examples:</p>
                <ul>
                    <li>Red, blue, red, blue...</li>
                    <li>Circle, square, circle, square...</li>
                    <li>Big, small, big, small...</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Draw a circle and color it.</li>
                    <li>Find a square in the room and point to it.</li>
                    <li>Make a pattern with 3 red beads and 2 blue beads.</li>
                    <li>What shape is a pizza? (Triangle)</li>
                    <li>Continue the pattern: apple, banana, apple, banana, ___</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Shapes_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download shapes worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Shapes are all around us! Look for them in nature and buildings.
                </div>
                <div class="info-box">
                    Patterns can be made with anything - sounds, movements, or objects.
                </div>
                <div class="info-box">
                    Ask your teacher for shape cutouts to practice with.
                </div>
            </div>
