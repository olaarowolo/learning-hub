...
<head>
    ...
    <title>Autumn Term - Phonics</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .week-links li a:hover {
            background-color: var(--theme-color);
            transform: translateY(-2px);
        }
        .week-links li.disabled a {
            opacity: 0.5;
            pointer-events: none;
            cursor: not-allowed;
        }
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" style="position: absolute; top: 1rem; left: 50%; transform: translateX(-50%); color: white; font-size: 14px;">
            ...
            <a href="/data/yeargroups/EYFS/y0/subjects/phonics/index.html" style="color: white; text-decoration: none;">Phonics</a> >
            <span>Autumn</span>
        </nav>
        <h1>Autumn Term - Early Maths</h1>
        <a href="/data/yeargroups/EYFS/y0/subjects/maths/ma-index.html" class="back-link">← Back to Early Maths</a>
    </header>
    <main>
        <h2>Autumn Term Weeks</h2>
        <p>Select a week to view the learning materials.</p>
        <ul class="week-links">
            <li><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week1.html">Week 1</a></li>
            <li><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week2.html">Week 2</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week3.html">Week 3</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week4.html">Week 4</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week5.html">Week 5</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week6.html">Week 6</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week7.html">Week 7</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week8.html">Week 8</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week9.html">Week 9</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week10.html">Week 10</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week11.html">Week 11</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/maths/autumn/week12.html">Week 12</a></li>
        </ul>
    </main>
    <footer>
