...
<head>
    ...
    <title>Week 1 - Autumn Term - Phonics</title>
...
<body>
    <header class="year-header">
        <h1>Week 1 - Autumn Term - Phonics</h1>
        <a href="/data/yeargroups/EYFS/y0/subjects/phonics/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Week 1: Environmental Sounds</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week focuses on listening to and identifying environmental sounds to develop auditory discrimination skills.</p>
                <p>Children will learn to recognize different sounds in their environment and describe them.</p>
            </div>
            <div class="content-section">
