...
<head>
    ...
    <title>Creative Play - Reception</title>
...
<body>
    <header class="year-header">
        <h1>Creative Play - Reception</h1>
        <a href="/data/yeargroups/EYFS/y0/subjects/yrR-index.html" class="back-link">← Back to Reception Home</a>
    </header>
    <main>
        <h2>Welcome to Reception Early Creative Play!</h2>
        <p>This page contains the 12-week Early Creative Play plan for Reception.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/y0/subjects/creative-play/plan.html">Reception Early Creative Play Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/EYFS/y0/subjects/creative-play/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/creative-play/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/creative-play/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
