...
<head>
    ...
    <title>Understanding the World - Reception</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .year-header h1 { font-size: 2.75rem; text-shadow: 1px 1px 3px rgba(0,0,0,0.2); }
        ...
        main h2 { color: var(--theme-color); margin-bottom: 1rem; font-size: 2.25rem; }
...
<body>
    <header class="year-header">
        <h1>Understanding the World - Reception</h1>
        <a href="/data/yeargroups/EYFS/y0/subjects/yrR-index.html" class="back-link">← Back to Reception Home</a>
    </header>
    <main>
        <h2>Welcome to Reception Early Understanding the World!</h2>
        <p>This page contains the 12-week Early Understanding the World plan for Reception.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/y0/subjects/understanding-the-world/plan.html">Reception Early Understanding the World Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/EYFS/y0/subjects/understanding-the-world/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/understanding-the-world/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/EYFS/y0/subjects/understanding-the-world/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
