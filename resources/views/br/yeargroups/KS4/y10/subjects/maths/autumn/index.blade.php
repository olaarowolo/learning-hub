...
<head>
    ...
    <title>Year 10 Maths - Autumn Term</title>
...
<body>
    <header class="year-header">
        <h1>Autumn Term</h1>
        <a href="/data/yeargroups/KS4/y10/subjects/maths/ma-index.html" class="back-link">&larr; Back to Year 10 Maths</a>
    </header>
    <div class="container">
        <main>
            <h2>Year 10 Maths - Autumn Term</h2>
            <p>This is a placeholder for the Autumn Term content.</p>
            <p>Add weekly lessons, exercises, and resources here.</p>
        </main>
    </div>
    <footer>
