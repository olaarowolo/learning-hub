...
<head>
    ...
    <title>Year 10 - Mathematics</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-10: #3f51b5; --color-year-10-light: #6573c3;
...
<body>
    <header class="year-header">
        <h1>Year 10 - Mathematics</h1>
        <a href="/data/yeargroups/y10/yr10-index.html" class="back-link">← Back to Year 10 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 10 Mathematics!</h2>
        <p>This is a placeholder page for Year 10 Mathematics subject content.</p>
        <p>Add notes, videos, exercises, and other learning materials here.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS4/y10/subjects/maths/plan.html">Year 10 Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS4/y10/subjects/maths/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS4/y10/subjects/maths/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS4/y10/subjects/maths/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
