...
<body>
    <header class="year-header">
        <h1>Year 10 - English</h1>
        <a href="/data/yeargroups/KS4/y10/yr10-index.html" class="back-link">← Back to Year 10 Home</a>
    </header>
    <div class="container">
        <main>
            <h2>Welcome to Year 10 English!</h2>
            <p>Develop your analytical, creative, and formal writing skills through critical reading, speaking, and studying a range of literature, non-fiction, and poetry texts. Prepare for GCSE examinations with clarity, style, and precision in your writing.</p>

            <h3 class="subject-title">Curriculum Resources</h3>
            <ul class="resource-links">
                <li><a href="/data/yeargroups/KS4/y10/subjects/english/plan.html">Year 10 English Curriculum Plan</a></li>
            </ul>

            <h3 class="subject-title">Term Content</h3>
            <ul class="term-links">
                <li><a href="/data/yeargroups/KS4/y10/subjects/english/autumn/">Autumn Term</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS4/y10/subjects/english/spring/">Spring Term</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS4/y10/subjects/english/summer/">Summer Term</a></li>
            </ul>
        </main>
    </div>
    <footer>
