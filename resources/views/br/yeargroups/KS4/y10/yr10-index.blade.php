...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-10: #3f51b5; /* Indigo */
            --color-year-10-light: #6573c3;
...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            <h2>Subjects</h2>
            <ul>
                <li><a href="/data/yeargroups/KS4/y10/subjects/maths/ma-index.html" class="active">Mathematics</a></li>
                <li><a href="/data/yeargroups/KS4/y10/subjects/english/en-index.html">English</a></li>
        ...
        <main class="content">
            <h2>Welcome to Year 10 Mathematics!</h2>
