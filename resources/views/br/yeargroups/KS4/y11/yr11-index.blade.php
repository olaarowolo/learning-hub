...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/nav.css" /><link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" rel="stylesheet">
    
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-11: #6a1b9a; /* Purple for Year 11 */
            --color-year-11-light: #ab47bc;
...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            <h2>Subjects</h2>
            <ul id="subject-links">
                <li><a id="mathematics" href="/data/yeargroups/KS4/y11/subjects/maths/ma-index.html">Mathematics</a></li>
                <li><a id="english" href="/data/yeargroups/KS4/y11/subjects/english/en-index.html" class="active">English</a></li>
                <li><a id="science" href="/data/yeargroups/KS4/y11/subjects/science.html">Science</a></li>
                <li><a id="history" href="/data/yeargroups/KS4/y11/subjects/history.html">History</a></li>
                <li><a id="geography" href="/data/yeargroups/KS4/y11/subjects/geography.html">Geography</a></li>
                <li><a id="art" href="/data/yeargroups/KS4/y11/subjects/art.html">Art</a></li>
            </ul>
        </aside>

        <main class="content">
            <h2>Welcome to Year 11 English!</h2>
            <p>This is your central hub for Year 11 English. Use the navigation to access curriculum plans, term content, and weekly lessons.</p>
            <p>Select another subject from the sidebar to explore other subjects.</p>
        </main>
    </div>
