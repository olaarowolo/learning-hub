...
<head>
    ...
    <title>Year 11 English - Curriculum Plan</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-11: #6a1b9a; --color-year-11-light: #ab47bc;
            --theme-color: var(--color-year-11);
            --theme-color-light: var(--color-year-11-light);
...
<body>
    <header class="year-header">
        <h1>Year 11 English - Curriculum Plan</h1>
        <a href="/data/yeargroups/KS4/y11/subjects/english/en-index.html" class="back-link">← Back to English Home</a>
    </header>
    <main>
        <h2>Year 11 English Curriculum Plan (by Week)</h2>
        <p>Year 11 English focuses on advanced reading, writing, speaking, and listening skills, preparing pupils for GCSE examinations. Pupils study fiction, non-fiction, poetry, and drama, developing analytical, creative, and formal writing abilities.</p>

        <div class="term">
            <h3>Autumn Term</h3>
            <p>Focus: Reading comprehension, analytical writing, grammar, and punctuation</p>
            <ul>
                <li><strong>Weeks 1–2:</strong> Reading comprehension – inference, deduction, evaluating themes and viewpoints</li>
                <li><strong>Weeks 3–4:</strong> Narrative writing – plot, characterisation, setting, tension, and dialogue</li>
                <li><strong>Weeks 5–6:</strong> Grammar – complex sentences, relative clauses, conjunctions, stylistic devices, sentence variety</li>
                <li><strong>Weeks 7–8:</strong> Punctuation – semi-colons, colons, dashes, brackets, inverted commas, ellipses</li>
                <li><strong>Weeks 9–10:</strong> Analytical writing – responding to texts with evidence and evaluation</li>
                <li><strong>Weeks 11–12:</strong> Speaking and listening – presentations, debates, storytelling performances, exam-style discussions</li>
            </ul>
        </div>

        <div class="term">
            <h3>Spring Term</h3>
            <p>Focus: Non-fiction writing, poetry, extended analysis, and exam skills</p>
            <ul>
                <li><strong>Weeks 1–2:</strong> Reading comprehension – analysing author's techniques, language, structure, comparing texts</li>
                <li><strong>Weeks 3–4:</strong> Non-fiction writing – analytical essays, persuasive texts, formal letters, reports; focus on structure, audience, and purpose</li>
                <li><strong>Weeks 5–6:</strong> Narrative writing – descriptive and imaginative writing, dialogue, plot structure, character depth</li>
                <li><strong>Weeks 7–8:</strong> Poetry – analysis of poetic techniques, structure, tone, imagery, and creating original poems</li>
                <li><strong>Weeks 9–10:</strong> Grammar – advanced adverbs, prepositions, modal verbs, passive voice, sentence variety, stylistic devices</li>
                <li><strong>Weeks 11–12:</strong> Editing and proofreading – refining grammar, punctuation, vocabulary, sentence structure, and exam technique</li>
            </ul>
        </div>

        <div class="term">
            <h3>Summer Term</h3>
            <p>Focus: Creative writing, analytical reading, GCSE exam preparation</p>
            <ul>
                <li><strong>Weeks 1–2:</strong> Reading comprehension – evaluating texts, comparing authors' techniques, identifying themes, tone, and style</li>
                ...
                <li><strong>Weeks 5–6:</strong> Non-fiction – formal reports, persuasive texts, analytical essays, letters, and speeches</li>
                <li><strong>Weeks 7–8:</strong> Creative writing – descriptive passages, diary entries, short plays, monologues</li>
                ...
                <li><strong>Weeks 11–12:</strong> Final GCSE-style assessment – reading fluency, comprehension, creative and non-fiction writing, grammar, punctuation, vocabulary, and analytical skills</li>
            </ul>
        </div>
    </main>
    <footer>
