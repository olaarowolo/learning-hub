...
<head>
    ...
    <title>Year 11 English - Spring Term</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        ...
        * {
        ...
        ul.week-links li a:hover {
            background-color: var(--theme-color);
            transform: translateY(-2px);
        }
        ul.week-links li.disabled a {
...
<body>
    <header class="year-header">
        <h1>Year 11 English - Spring Term</h1>
    ...
    <main class="container">
        ...
        <ul class="week-links">
            <li class="disabled"><a href="#">Week 1</a></li>
