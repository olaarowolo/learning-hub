...
<head>
    ...
    <title>Year 11 English - Autumn Term</title>
...
<body>
    <header class="year-header">
        <h1>Year 11 English - Autumn Term</h1>
    ...
    <main class="container">
        ...
        <ul class="week-links">
            <li><a href="/data/yeargroups/KS4/y11/subjects/english/autumn/week1.html">Week 1</a></li>
