...
<head>
    ...
    <title>Year 4 English - Spring Week 1</title>
...
<body>
    <header class="year-header">
        <h1>Year 4 English - Spring Week 1</h1>
        <a href="/data/yeargroups/KS2/y4/subjects/english/spring/index.html" class="back-link">← Back to Spring Term</a>
    </header>
    <main class="container">
        <section class="content-section">
            ...
            <ul class="activity-list">
                <li>Read a story or passage carefully.</li>
                <li>Discuss what the author implies but does not state directly.</li>
                <li>Make predictions about what might happen next.</li>
            </ul>
        </section>
        <section class="content-section assessment">
            <h3>Assessment</h3>
            <p>Complete a worksheet with inference questions based on a short text.</p>
        </section>
    </main>
    <footer>
