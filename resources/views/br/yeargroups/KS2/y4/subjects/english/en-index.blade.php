...
<body>
    ...
    <main class="container">
        ...
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS2/y4/subjects/english/plan.html">Year 4 English Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS2/y4/subjects/english/autumn/">Autumn Term</a></li>
            <li><a href="/data/yeargroups/KS2/y4/subjects/english/spring/">Spring Term</a></li>
            <li><a href="/data/yeargroups/KS2/y4/subjects/english/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
