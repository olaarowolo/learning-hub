...
<head>
    ...
    <title>Year 4 - Mathematics</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            ...
            <span>KS2</span> >
            <a href="/data/yeargroups/KS2/y4/yr4-index.html">Year 4</a> >
            <span>Maths</span>
        </nav>
        <h1>Year 4 - Mathematics</h1>
        <a href="/data/yeargroups/KS2/y4/yr4-index.html" class="back-link">← Back to Year 4 Home</a>
    </header>
    <main>
        ...
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS2/y4/subjects/maths/plan.html">Year 4 Maths Curriculum Plan</a></li>
        </ul>
