...
<head>
  ...
  <title>Counting Patterns - up to 100 - Year 3 Maths</title>
...
<body>
  <header class="year-header">
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
      ...
      <span>Counting Patterns - up to 100</span>
    </nav>
    <h1>Counting Patterns - up to 100</h1>
  ...
  <div class="container">
    <main>
      ...
      <p>Explore and practise counting in different patterns up to 100. Recognising and extending number patterns helps strengthen number sense and prepares learners for multiplication.</p>

      <h3>Instructions</h3>
      <ul>
        <li>Count forwards and backwards in steps of 2, 3, 5, and 10.</li>
        <li>Identify missing numbers in counting sequences.</li>
        <li>Spot repeating patterns on a number line or hundred chart.</li>
        <li>Create your own counting sequence and ask a partner to continue it.</li>
      </ul>

      <p><em>Interactive number pattern games will be added soon.</em></p>
    </main>
  </div>
