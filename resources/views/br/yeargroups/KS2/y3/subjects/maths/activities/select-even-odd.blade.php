...
<title>Select Even or Odd Numbers - Year 3 Maths</title>
...
<a href="{{ route('home') }}">Home</a> &gt;<span>Year Groups</span> &gt;<span>KS2</span> &gt;<a href="/data/yeargroups/KS2/y3/yr3-index.html">Year 3</a> &gt;<a href="/data/yeargroups/KS2/y3/subjects/maths/activities/index.html">Activities Index</a> &gt;<span>Select Even or Odd Numbers</span>
</nav>
<h1>Select Even or Odd Numbers</h1>
...
<h3>Select Numbers by Parity</h3>
<ul>
<li>Even numbers are divisible by 2; odd numbers are not.</li>
<li>Independent practice reinforces pattern recognition.</li>
</ul>
</div>
</main>
...
<div class="interactive-box-container" id="select-even-odd"></div>
</main>
</div>
...
const container=document.getElementById('select-even-odd');
numbers.forEach((n,i)=>{
...
btn.onclick=()=>{
  numbers.forEach((n,i)=>{
    ...
    if((n%2!==0 && cb.checked) || (n%2===0 && !cb.checked)){
      ...
      cb.parentElement.style.backgroundColor='#ffcdd2';
    }
  });
};
