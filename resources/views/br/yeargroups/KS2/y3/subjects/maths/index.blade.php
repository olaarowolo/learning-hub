...
<head>
    ...
    <title>Year 3 Maths - Summer Term</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        main { background-color: var(--card-bg); padding: 2rem; border-radius: 12px; box-shadow: var(--card-shadow); text-align: center; }
...
<body>
    <header class="year-header">
        <h1>Summer Term</h1>
        <a href="../ma-index.html" class="back-link">&larr; Back to Year 3 Maths</a>
    </header>
    <div class="container">
        <main>
            <h2>Content Coming Soon!</h2>
            <p>The weekly content for the Summer term is currently under development. Please check back later.</p>
        </main>
    </div>
</body>
</html>
