...
<title>Number Lines - up to 100 - Year 3 Maths</title>
...
.number-line-container { overflow-x: auto; padding: 1rem 0; }
.number-line { display: flex; height: 60px; align-items: flex-end; }
.tick { display: flex; flex-direction: column; align-items: center; width: 30px; margin-right: 2px; }
.tick-line { width: 2px; height: 30px; background-color: var(--theme-color); }
.tick-label { font-size: 12px; margin-top: 2px; }
...
<nav aria-label="breadcrumb" class="breadcrumb-nav">
  ...
  <span>Number Lines - up to 100</span>
</nav>
<h1>Number Lines - up to 100</h1>
...
<h3>Using Number Lines up to 100</h3>
<ul>
  <li>Understand sequencing and place value using a number line.</li>
  <li>Practice counting forwards and backwards in ones, twos, and tens.</li>
  <li>Independent learning: fill in missing numbers or create your own number lines for practice.</li>
</ul>
</div>
</main>
...
<div class="number-line-container">
  <div class="number-line" id="number-line-100"></div>
</div>
</main>
</div>
...
<script>
const container = document.getElementById('number-line-100');
for(let i=0;i<=100;i++){
