...
<title>Identify Numbers as Even or Odd - Year 3 Maths</title>
...
.interactive-box input[type=checkbox]{margin-right:0.5rem;}
...
<a href="{{ route('home') }}">Home</a> &gt;<span>Year Groups</span> &gt;<span>KS2</span> &gt;<a href="/data/yeargroups/KS2/y3/yr3-index.html">Year 3</a> &gt;<a href="/data/yeargroups/KS2/y3/subjects/maths/activities/index.html">Activities Index</a> &gt;<span>Identify Numbers as Even or Odd</span>
</nav>
<h1>Identify Numbers as Even or Odd</h1>
...
<h3>Recognising Even and Odd Numbers</h3>
<ul>
<li>Even numbers end with 0,2,4,6,8; odd numbers end with 1,3,5,7,9.</li>
<li>Practise spotting patterns in sequences independently.</li>
</ul>
</div>
</main>
...
<div class="interactive-box-container" id="identify-even-odd"></div>
</main>
</div>
...
const container=document.getElementById('identify-even-odd');
numbers.forEach((n,i)=>{
  const div=document.createElement('div');
  div.className='interactive-box';
  div.innerHTML=`<input type="checkbox" id="chk-${i}">${n}`;
...
btn.onclick=()=>{
  numbers.forEach((n,i)=>{
    ...
    if((n%2===0 && cb.checked)||(n%2!==0 && !cb.checked)){
      cb.parentElement.style.backgroundColor='#c8e6c9';
    } else { cb.parentElement.style.backgroundColor='#ffcdd2'; }
  });
};
