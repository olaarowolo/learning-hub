...
<head>
  ...
  <title>Number Lines - up to 1,000 - Year 3 Maths</title>
...
<body>
  <header class="year-header">
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
      ...
      <span>Number Lines - up to 1,000</span>
    </nav>
    <h1>Number Lines - up to 1,000</h1>
  ...
  <div class="container">
    <main>
      ...
      <p>Use number lines to explore numbers up to 1,000. This activity helps learners understand larger sequences and develop place value skills.</p>

      <h3>Instructions</h3>
      <ul>
        <li>Count forwards and backwards in ones, tens, and hundreds up to 1,000.</li>
        <li>Fill in missing numbers in number lines extending to 1,000.</li>
        <li>Practice identifying patterns and sequences in larger numbers.</li>
        <li>Challenge: Count in steps of 25, 50, or 100 along the number line.</li>
      </ul>

      <p><em>Interactive number line activities will be added soon.</em></p>
    </main>
  </div>
