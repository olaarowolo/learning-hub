...
<title>Even or Odd Numbers on Number Lines - Year 3 Maths</title>
...
.interactive-box input.number-input{width:40px;text-align:center;margin-right:0.5rem;}
...
<a href="{{ route('home') }}">Home</a> &gt;<span>Year Groups</span> &gt;<span>KS2</span> &gt;<a href="/data/yeargroups/KS2/y3/yr3-index.html">Year 3</a> &gt;<a href="/data/yeargroups/KS2/y3/subjects/maths/activities/index.html">Activities Index</a> &gt;<span>Even or Odd Numbers on Number Lines</span>
</nav>
<h1>Even or Odd Numbers on Number Lines</h1>
...
<h3>Even & Odd Patterns on Number Lines</h3>
<ul>
<li>Even numbers divisible by 2, odd numbers are not.</li>
<li>Notice the repeating pattern along the number line.</li>
<li>Independent practice strengthens recognition skills.</li>
</ul>
</div>
</main>
...
<div class="interactive-box-container" id="number-line"></div>
</main>
</div>
...
numbers.forEach((n)=>{
  ...
  div.textContent=n;
  div.style.backgroundColor=n%2===0?'#c8e6c9':'#fff9c4';
