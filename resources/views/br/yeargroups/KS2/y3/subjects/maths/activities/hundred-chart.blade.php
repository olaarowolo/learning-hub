...
<head>
  ...
  <title>Hundred Chart - Year 3 Maths</title>
...
<body>
  ...
  <div class="container">
    <main>
      ...
      <p>Use the hundred chart to explore numbers up to 100. It helps learners visualise counting, sequences, and patterns.</p>

      <h3>Instructions</h3>
      <ul>
        <li>Identify numbers in rows and columns on the hundred chart.</li>
        <li>Highlight all multiples of 2, 5, or 10.</li>
        <li>Practice finding missing numbers in sequences on the chart.</li>
        <li>Challenge: Count in different steps (e.g., 3s, 4s) across the chart.</li>
      </ul>

      <p><em>Interactive hundred chart activities coming soon.</em></p>
    </main>
  </div>
