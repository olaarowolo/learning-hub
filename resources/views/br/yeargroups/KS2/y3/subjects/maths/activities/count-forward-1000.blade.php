...
<head>
  ...
  <title>Count Forward - up to 1,000 - Year 3 Maths</title>
...
<body>
  <header class="year-header">
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
      ...
      <span>Count Forward - up to 1,000</span>
    </nav>
    <h1>Count Forward - up to 1,000</h1>
  ...
  <div class="container">
    <main>
      ...
      <p>Practise counting forwards up to 1,000. This activity helps learners build confidence with larger numbers and sequences.</p>

      <h3>Instructions</h3>
      <ul>
        <li>Count forwards in ones, tens, and hundreds starting from any number below 1,000.</li>
        <li>Complete sequences where some numbers are missing.</li>
        <li>Challenge: Count forwards in steps of 25 or 50 to improve speed and fluency.</li>
        <li>Try real-life counting: e.g., counting items in hundreds or large sets.</li>
      </ul>

      <p><em>Interactive counting activities will be added soon.</em></p>
    </main>
  </div>
