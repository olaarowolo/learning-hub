...
<head>
    ...
    <title>Week 7 - Year 6 Maths</title>
...
<body>
    <header class="year-header">
        <h1>Week 7: Factors & Multiples</h1>
        <a href="/data/yeargroups/KS2/y6/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Factors & Multiples</h2>
            
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we explore the building blocks of numbers: factors and multiples. Understanding these concepts is essential for working with fractions, primes, and algebra later on. We'll learn how to find them and see how they appear in real-life situations.</p>
            </div>

            <div class="content-section">
                <h3>Key Concepts Covered</h3>
                <ul>
                    <li><strong>Factors:</strong> Defining what a factor is and finding all the factor pairs of a number up to 100.</li>
                    <li><strong>Multiples:</strong> Defining what a multiple is and identifying them in different contexts.</li>
                    <li><strong>Real-Life Applications:</strong> Seeing how multiples are used in timetables and understanding repeating events.</li>
                </ul>
            </div>

            <div class="task-box">
                <h3>In-Class Activities</h3>
                <p>Let's get hands-on with factors and multiples:</p>
                <ul>
                    <li><strong>Factor Pair Hunt:</strong> A worksheet challenge to find all the factor pairs for a given set of numbers.</li>
                    <li><strong>"Find My Multiple" Game:</strong> A fun class activity to quickly identify multiples of different numbers.</li>
                </ul>
            </div>

            <div class="info-box">
                <h4>📖 Homework</h4>
                <p>Your homework this week is a worksheet on prime factorisation. This will prepare you for next week's topic on Primes, HCF, and LCM.</p>
            </div>
        </main>
    </div>
    <footer>
