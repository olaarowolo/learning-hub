...
<head>
    ...
    <title>Year 6 Maths - Summer Term</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .term-content { margin-bottom: 2rem; }
        .term-content h3 { color: var(--theme-color); margin-bottom: 0.5rem; font-size: 1.4rem; }
        .term-content ul { margin-left: 1rem; }
        .term-content li { margin-bottom: 0.5rem; }
...
<body>
    <header class="year-header">
        <h1>Year 6 Maths - Summer Term</h1>
        <a href="/data/yeargroups/KS2/y6/subjects/maths/mathematics.html" class="back-link">← Back to Maths Home</a>
    </header>
    <main>
        <h2>Summer Term Content</h2>
        <ul class="week-list">
            <li class="disabled"><a href="#"><span class="week-number">Weeks 1–2</span> Angles</a></li>
            <li class="disabled"><a href="#"><span class="week-number">Weeks 3–4</span> Handling data and statistical diagrams</a></li>
            <li class="disabled"><a href="#"><span class="week-number">Week 5</span> Proportion</a></li>
            <li class="disabled"><a href="#"><span class="week-number">Week 6</span> End of Year Assessment</a></li>
            <li class="disabled"><a href="#"><span class="week-number">Weeks 7–9</span> Fractions, decimals and percentages</a></li>
            <li class="disabled"><a href="#"><span class="week-number">Weeks 10–11</span> Probability</a></li>
            <li class="disabled"><a href="#"><span class="week-number">Week 12</span> Assessment & Revision</a></li>
        </ul>
    </main>
    <footer>
