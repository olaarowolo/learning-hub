...
<head>
    ...
    <title>Year 6 Maths - Curriculum Plan</title>
...
<body>
    <header class="year-header">
        <h1>Year 6 Maths - Curriculum Plan</h1>
        <a href="/data/yeargroups/KS2/y6/subjects/maths/ma-index.html" class="back-link">← Back to Maths Home</a>
    </header>
    <main>
        <h2>Year 6 Mathematics Curriculum Plan (by Week)</h2>
