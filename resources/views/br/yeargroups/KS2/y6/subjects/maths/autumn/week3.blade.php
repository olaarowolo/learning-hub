...
<head>
    ...
    <title>Week 3 - Year 6 Maths</title>
...
<body>
    <header class="year-header">
        <h1>Week 3: Addition & Subtraction</h1>
        <a href="/data/yeargroups/KS2/y6/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Addition & Subtraction</h2>
            
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we build on our number skills by mastering addition and subtraction. We'll explore quick mental strategies and formal written methods to solve problems accurately and efficiently, including those involving decimals and multiple steps.</p>
            </div>

            <div class="content-section">
                <h3>Key Concepts Covered</h3>
                <ul>
                    <li><strong>Mental Strategies:</strong> Using techniques like compensation and partitioning to calculate in your head.</li>
                    <li><strong>Column Method:</strong> Applying formal column addition and subtraction for large numbers.</li>
                    <li><strong>Working with Decimals:</strong> Adding and subtracting numbers with up to three decimal places.</li>
                    <li><strong>Multi-Step Word Problems:</strong> Breaking down complex problems into smaller, manageable steps.</li>
                </ul>
            </div>

            <div class="task-box">
                <h3>In-Class Activities</h3>
                <p>We'll put your skills to the test with these practical activities:</p>
                <ul>
                    <li><strong>Shopping Receipt Challenge:</strong> Calculate totals and change using real-life shopping scenarios.</li>
                    <li><strong>Error-Spotting:</strong> Become a detective and find the mistakes in a series of calculations.</li>
                </ul>
            </div>

            <div class="info-box">
                <h4>📖 Homework</h4>
                <p>This week's homework will be a worksheet filled with word problems that require both addition and subtraction. This will help you practice applying your skills to different contexts.</p>
            </div>
        </main>
    </div>
    <footer>
