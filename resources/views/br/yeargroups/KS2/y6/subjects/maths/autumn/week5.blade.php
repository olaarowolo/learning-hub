...
<head>
    ...
    <title>Week 5 - Year 6 Maths</title>
...
<body>
    <header class="year-header">
        <h1>Week 5: Division</h1>
        <a href="/data/yeargroups/KS2/y6/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Division</h2>
            
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we tackle division. You'll learn reliable methods for both short and long division, understand how to handle remainders, and use divisibility tests to find factors quickly. We'll apply these skills to solve problems involving sharing and grouping.</p>
            </div>

            <div class="content-section">
                <h3>Key Concepts Covered</h3>
                <ul>
                    <li><strong>Short & Long Division:</strong> Confidently use formal methods to divide up to a 4-digit number by a 2-digit number.</li>
                    <li><strong>Interpreting Remainders:</strong> Express remainders as whole numbers, fractions, or decimals depending on the context.</li>
                    <li><strong>Divisibility Tests:</strong> Learn shortcuts to test if a number is divisible by 2, 3, 4, 5, 6, 9, and 10.</li>
                    <li><strong>Problem Solving:</strong> Solve word problems that require division, such as sharing items equally or scaling down quantities.</li>
                </ul>
            </div>

            <div class="task-box">
                <h3>In-Class Activities</h3>
                <p>Let's practice division with these interactive tasks:</p>
                <ul>
                    <li><strong>Divisibility Card Sort:</strong> Quickly sort numbers into categories based on their divisibility.</li>
                    <li><strong>Real-World Scenarios:</strong> Solve problems about arranging bus seating, forming teams, or packaging items into boxes.</li>
                </ul>
            </div>

            <div class="info-box">
                <h4>📖 Homework</h4>
                <p>A division challenge sheet awaits you for homework! It will include a mix of calculations and word problems to solidify your understanding.</p>
            </div>
        </main>
    </div>
    <footer>
