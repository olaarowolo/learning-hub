...
<head>
    ...
    <title>Year 6 - Mathematics</title>
...
<body>
    <header class="year-header">
        <h1>Year 6 - Mathematics</h1>
        <a href="/data/yeargroups/KS2/y6/yr6-index.html" class="back-link">← Back to Year 6 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 6 Mathematics!</h2>
        <p>This is a placeholder page for Year 6 Mathematics subject content.</p>
        <p>Add notes, videos, exercises, and other learning materials here.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS2/y6/subjects/maths/plan.html">Year 6 Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS2/y6/subjects/maths/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS2/y6/subjects/maths/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS2/y6/subjects/maths/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
