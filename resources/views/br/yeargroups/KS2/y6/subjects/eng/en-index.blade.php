...
<body>
    <header class="year-header">
        <h1>Year 6 - English</h1>
        <a href="/data/yeargroups/KS2/y6/subjects/yr6-index.html" class="back-link">← Back to Year 6 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 6 English!</h2>
        ...
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS2/y6/subjects/english/plan.html">Year 6 English Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS2/y6/subjects/english/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS2/y6/subjects/english/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS2/y6/subjects/english/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
