...
<head>
    ...
    <title>Week 1 - Year 6 English</title>
...
<body>
    <header class="year-header">
        ...
        <a href="/data/yeargroups/KS2/y6/subjects/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Introduction to Year 6 English & Diagnostic Writing</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Welcome to Year 6 English! This week, we'll get to know each other and explore what English at secondary school is all about. We will also complete a short piece of writing to see your current skills.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <div class="task-box">
                    <h4>Diagnostic Writing Task</h4>
                    <p>You will be asked to write a short story (around 200-300 words) based on a picture prompt. This is not a test! It's a way for your teacher to understand your writing style, your creativity, and what areas we can work on together this year.</p>
                    <p><strong>Focus on:</strong> Using interesting vocabulary, structuring your story with a beginning, middle, and end, and checking your spelling and punctuation.</p>
                </div>
            </div>
        </main>
    </div>
