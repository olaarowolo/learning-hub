...
<head>
    ...
    <title>Year 5 - Mathematics</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            ...
            <span>KS2</span> >
            <a href="/data/yeargroups/KS2/y5/yr5-index.html">Year 5</a> >
            <span>Maths</span>
        </nav>
        <h1>Year 5 - Mathematics</h1>
    ...
    <main>
        ...
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS2/y5/subjects/maths/plan.html">Year 5 Maths Curriculum Plan</a></li>
        </ul>
