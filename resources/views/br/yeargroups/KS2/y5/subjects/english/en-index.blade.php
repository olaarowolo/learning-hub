...
<body>
    <header class="year-header">
        <h1>Year 5 - English</h1>
        <a href="/data/yeargroups/KS2/y5/yr5-index.html" class="back-link">← Back to Year 5 Home</a>
    </header>
    <main class="container">
        <h2>Welcome to Year 5 English!</h2>
        <p>Explore advanced language skills, literature, and writing techniques. Use the links below to navigate through the curriculum and term content.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS2/y5/subjects/english/plan.html">Year 5 English Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS2/y5/subjects/english/autumn/">Autumn Term</a></li>
            <li><a href="/data/yeargroups/KS2/y5/subjects/english/spring/">Spring Term</a></li>
            <li><a href="/data/yeargroups/KS2/y5/subjects/english/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
