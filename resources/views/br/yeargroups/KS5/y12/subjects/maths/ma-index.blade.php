...
<head>
    ...
    <title>Year 12 - Mathematics</title>
...
<body>
    <header class="year-header">
        <h1>Year 12 - Mathematics</h1>
        <a href="/data/yeargroups/KS5/y12/yr12-index.html" class="back-link">← Back to Year 12 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 12 Mathematics!</h2>
        <p>This is a placeholder page for Year 12 Mathematics subject content.</p>
        <p>Add notes, videos, exercises, and other learning materials here.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS5/y12/subjects/maths/plan.html">Year 12 Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS5/y12/subjects/maths/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS5/y12/subjects/maths/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS5/y12/subjects/maths/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
