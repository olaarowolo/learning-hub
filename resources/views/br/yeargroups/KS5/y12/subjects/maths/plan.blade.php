...
<head>
    ...
    <title>Year 12 Maths - Curriculum Plan</title>
...
<body>
    <header class="year-header">
        <h1>Year 12 Maths - Curriculum Plan</h1>
        <a href="/data/yeargroups/KS5/y12/subjects/maths/ma-index.html" class="back-link">← Back to Maths Home</a>
    </header>
    <main>
        <h2>Year 12 Mathematics Curriculum Plan (by Week)</h2>

        <div class="term">
            <h3>Autumn Term</h3>
            <ul>
                <li><strong>Week 1:</strong> Baseline Assessment</li>
                <li><strong>Weeks 2–6:</strong> Algebraic Methods</li>
                <li><strong>Weeks 7–8:</strong> Functions and Graphs</li>
                <li><strong>Week 9:</strong> Sequences and Series</li>
                <li><strong>Week 10:</strong> Trigonometry</li>
                <li><strong>Week 11:</strong> Calculus</li>
        ...
        <div class="term">
            <h3>Spring Term</h3>
            <ul>
                <li><strong>Weeks 1–2:</strong> Vectors</li>
                <li><strong>Weeks 3–4:</strong> Statistical Sampling</li>
                <li><strong>Week 5:</strong> Probability</li>
                <li><strong>Weeks 6–7:</strong> Binomial Expansion</li>
                <li><strong>Weeks 9–10:</strong> Differentiation</li>
                <li><strong>Week 11:</strong> Integration</li>
                <li><strong>Week 12:</strong> Assessment & Revision</li>
            </ul>
        </div>
        ...
        <div class="term">
            <h3>Summer Term</h3>
            <ul>
                <li><strong>Weeks 1–2:</strong> Exponentials and Logarithms</li>
                <li><strong>Weeks 3–4:</strong> Numerical Methods</li>
                <li><strong>Week 5:</strong> Proof</li>
                <li><strong>Week 6:</strong> Mock Exams</li>
                <li><strong>Weeks 7–9:</strong> Revision Topics</li>
                <li><strong>Weeks 10–11:</strong> Final Preparation</li>
                <li><strong>Week 12:</strong> End of Year Exams</li>
            </ul>
        </div>
    </main>
    <footer>
