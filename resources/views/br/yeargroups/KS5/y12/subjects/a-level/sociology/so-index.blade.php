...
<head>
    ...
    <title>A-Level Sociology - Year 12</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-a-level: #9c27b0; --color-year-a-level-light: #ba68c8;
            --theme-color: var(--color-year-a-level);
            --theme-color-light: var(--color-year-a-level-light);
...
<body>
    <header class="year-header">
        <h1>A-Level Sociology - Year 12</h1>
        <a href="/data/yeargroups/KS5/y12/yr12-index.html" class="back-link">← Back to Year 12 Home</a>
    </header>
    <div class="container">
        <aside class="sidebar">
            <h2>Navigation</h2>
            <ul id="content-links">
                <li><a id="plan" href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/plan.html">Curriculum Plan</a></li>
                <li><a id="autumn" href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/autumn/index.html">Autumn Term</a></li>
                <li class="disabled"><a id="spring" href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/spring/index.html">Spring Term</a></li>
                <li class="disabled"><a id="summer" href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/summer/index.html">Summer Term</a></li>
            </ul>
        </aside>
        <main class="content">
            <h2>Welcome to A-Level Sociology!</h2>
            <p>This course covers introduction to sociology, research methods, education, and families & households.</p>
            <p>Add notes, videos, exercises, and other learning materials here.</p>

            <h3 class="subject-title">Curriculum Resources</h3>
            <ul class="resource-links">
                <li><a href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/plan.html">A-Level Sociology Curriculum Plan</a></li>
            </ul>

            <h3 class="subject-title">Term Content</h3>
            <ul class="term-links">
                <li><a href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/autumn/index.html">Autumn Term</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/spring/index.html">Spring Term</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/summer/index.html">Summer Term</a></li>
            </ul>
        </main>
    </div>
    <footer>
                        ...
                        .catch(error => {
                            ...
                            contentArea.innerHTML = `
                                <div style="text-align: center; padding: 3rem 1rem;">
                                    ...
                                    <a href="/data/yeargroups/KS5/y12/yr12-index.html" style="display: inline-block; background-color: var(--theme-color); color: white; padding: 0.75rem 1.5rem; border-radius: 25px; text-decoration: none; font-weight: 600;">Back to Year 12 Home</a>
                                </div>
                            `;
                        });
                });
