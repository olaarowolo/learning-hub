...
<head>
    ...
    <title>A-Level Subjects - Year 12</title>
...
<body>
    <header class="year-header">
        <h1>A-Level Subjects - Year 12</h1>
        <a href="/data/yeargroups/KS5/y12/subjects/index.html" class="back-link">← Back to Subjects</a>
    </header>
    <main>
        <h2>Available A-Level Subjects</h2>
        <ul class="subject-list">
            <li><a href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/so-index.html">Sociology</a></li>
        </ul>
    </main>
    <footer>
