...
<head>
    ...
    <title>A-Level Sociology - Summer Term</title>
...
<body>
    <header class="year-header">
        <h1>A-Level Sociology - Summer Term</h1>
        <a href="/data/yeargroups/KS5/y12/subjects/a-level/sociology/so-index.html" class="back-link">← Back to Sociology Home</a>
    </header>
    <main>
        <h2>Summer Term - Weekly Content (Coming Soon)</h2>
        <ul class="week-list">
            <li><a href="#">Week 1: Introduction to Families & Households</a></li>
            <li><a href="#">Week 2: Family Types</a></li>
            <li><a href="#">Week 3: Theories of the Family: Functionalism</a></li>
            <li><a href="#">Week 4: Theories of the Family: Marxism</a></li>
            <li><a href="#">Week 5: Theories of the Family: Feminism</a></li>
            <li><a href="#">Week 6: Family Changes & Diversity</a></li>
            <li><a href="#">Week 7: Childhood & Socialisation</a></li>
            <li><a href="#">Week 8: Family Policies</a></li>
            <li><a href="#">Week 9: Applying Theory to Case Studies</a></li>
            <li><a href="#">Week 10: Research Methods in Families</a></li>
