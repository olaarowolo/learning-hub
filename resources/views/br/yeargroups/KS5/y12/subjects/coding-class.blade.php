...
<head>
    ...
    <title>Year 12 - Coding Class</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-12: #4caf50; /* Green */
            --color-year-12-light: #81c784;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        main a { display: inline-block; background-color: var(--theme-color); color: white; padding: 0.75rem 1.5rem; border-radius: 25px; text-decoration: none; font-weight: 600; transition: background-color 0.3s ease; }
        main a:hover { background-color: var(--theme-color-light); }
...
<body>
    <header class="year-header">
        <h1>Year 12 - Coding Class</h1>
        <a href="/data/yeargroups/KS5/y12/yr12-index.html" class="back-link">← Back to Year 12 Home</a>
    </header>
    <main>
        <h2>Oops! Content Not Found</h2>
        <p>We couldn't load the content for this subject. It might be under construction or the link is broken.</p>
