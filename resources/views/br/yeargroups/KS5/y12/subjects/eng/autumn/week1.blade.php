...
<head>
    ...
    <title>Week 1 - Year 12 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 1: Introduction & Diagnostic Writing</h1>
        <a href="/data/yeargroups/KS5/y12/subjects/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Introduction to Year 12 English & Diagnostic Writing</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Welcome to Year 12 English! This week, we'll get to know each other and explore what English at A-Level is all about. We will also complete a short piece of writing to see your current skills.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <div class="task-box">
                    <h4>Diagnostic Writing Task</h4>
                    <p>You will be asked to write a short analytical essay (around 500-700 words) based on a text extract. This is not a test! It's a way for your teacher to understand your analytical style, your critical thinking, and what areas we can work on together this year.</p>
                    <p><strong>Focus on:</strong> Using sophisticated vocabulary, structuring your essay with introduction, body, and conclusion, and applying literary techniques.</p>
                </div>
            </div>
        </main>
    </div>
