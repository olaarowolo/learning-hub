...
<body>
    ...
    <main>
        ...
        <ul class="week-list">
            <li><a href="#">Week 1: Introduction to Beliefs in Society</a></li>
            <li><a href="#">Week 2: Functionalist View of Religion</a></li>
            <li><a href="#">Week 3: Marxist View of Religion</a></li>
            <li><a href="#">Week 4: Feminist View of Religion</a></li>
            <li><a href="#">Week 5: Secularisation</a></li>
            <li><a href="#">Week 6: New Religious Movements</a></li>
            <li><a href="#">Week 7: Social Change and Religion</a></li>
            <li><a href="#">Week 8: Applying Theory to Case Studies</a></li>
            <li><a href="#">Week 9: Research Methods in Religion</a></li>
            <li><a href="#">Week 10: Contemporary Issues in Religion</a></li>
