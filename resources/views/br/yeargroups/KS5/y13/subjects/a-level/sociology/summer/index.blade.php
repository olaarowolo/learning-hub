...
<body>
    ...
    <main>
        ...
        <ul class="week-list">
            <li><a href="#">Week 1: Recap of Sociological Theories</a></li>
            <li><a href="#">Week 2: Research Methods Recap</a></li>
            <li><a href="#">Week 3: Applying Theory to Topics</a></li>
            <li><a href="#">Week 4: Evaluating Sociological Research</a></li>
            <li><a href="#">Week 5: Essay Writing Skills</a></li>
            <li><a href="#">Week 6: Past Paper Practice</a></li>
            <li><a href="#">Week 7: Mock Exam Preparation</a></li>
            <li><a href="#">Week 8: Advanced Essay Techniques</a></li>
            <li><a href="#">Week 9: Targeted Revision</a></li>
            <li><a href="#">Week 10: Final Assessments</a></li>
            <li><a href="#">Week 11: Review & Feedback</a></li>
            <li><a href="#">Week 12: End-of-Year Wrap-Up</a></li>
        </ul>
    </main>
    <footer>
