...
<head>
    ...
    <title>A-Level Subjects - Year 13</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .subject-list li { margin-bottom: 1rem; }
        .subject-list a { color: var(--theme-color); text-decoration: none; font-weight: 600; font-size: 1.2rem; transition: color 0.3s ease; }
        .subject-list a:hover { color: var(--theme-color-light); }
...
<body>
    <header class="year-header">
        <h1>A-Level Subjects - Year 13</h1>
        <a href="/data/yeargroups/KS5/y13/subjects/index.html" class="back-link">← Back to Subjects</a>
    </header>
    <main>
        <h2>Available A-Level Subjects</h2>
        <ul class="subject-list">
            <li><a href="/data/yeargroups/KS5/y13/subjects/a-level/sociology/so-index.html">Sociology</a></li>
        </ul>
    </main>
    <footer>
