...
<body>
    <header class="year-header">
        <h1>A-Level Sociology - Autumn Term</h1>
    ...
    <main>
        ...
        <ul class="week-list">
            <li><a href="/data/yeargroups/KS5/y13/subjects/a-level/sociology/autumn/week1.html" class="week-link"><span class="week-number">Week 1</span> Introduction to Crime & Deviance</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 2</span> Functionalist Perspective on Crime</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 3</span> Subcultural Theories of Crime</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 4</span> Marxist Perspective on Crime</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 5</span> Feminist Perspectives on Crime</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 6</span> Labelling Theory</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 7</span> Social Control and Punishment</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 8</span> Patterns & Trends in Crime</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 9</span> White-Collar & Corporate Crime</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 10</span> Research Methods in Crime</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 11</span> Applying Theory to Case Studies</a></li>
            <li class="disabled"><a href="#" class="week-link"><span class="week-number">Week 12</span> End-of-Term Assessment</a></li>
        </ul>
    </main>
    <!-- Floating Back Button -->
    <button class="floating-back-btn" onclick="window.location.href='../so-index.html'">
        ←
