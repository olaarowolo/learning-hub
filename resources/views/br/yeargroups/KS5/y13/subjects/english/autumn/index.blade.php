...
<head>
    ...
    <title>Year 13 English - Autumn Term</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        main h2 { color: var(--theme-color); margin-bottom: 1.5rem; }
        .week-list { list-style: none; }
        .week-list li { margin-bottom: 0.75rem; }
        .week-list a { display: block; padding: 1rem 1.5rem; background-color: #f1f3f5; border-radius: 8px; text-decoration: none; color: var(--text-dark); font-weight: 600; transition: background-color 0.3s, color 0.3s; }
        .week-list a:hover { background-color: var(--theme-color-light); color: white; }
        .week-list li.disabled a { background-color: #e9ecef; color: #adb5bd; pointer-events: none; }
        .week-list li.disabled a::after { content: ' (Coming Soon)'; font-style: italic; }
...
<body>
    ...
    <header class="year-header">
        <h1>Year 13 English - Autumn Term</h1>
        <a href="/data/yeargroups/KS5/y13/subjects/english/en-index.html" class="back-link">← Back to English Home</a>
    </header>
    <main>
        <h2>Weekly Content</h2>
        <ul class="week-list">
            <li><a href="/data/yeargroups/KS5/y13/subjects/english/autumn/week1.html">Week 1: Introduction to Year 13 & 'King Lear'</a></li>
            <li class="disabled"><a href="#">Week 2: 'King Lear': Act 2 Analysis</a></li>
            <li class="disabled"><a href="#">Week 3: 'King Lear': The Storm and Madness</a></li>
            <li class="disabled"><a href="#">Week 4: 'King Lear': Themes of Justice and Power</a></li>
            <li class="disabled"><a href="#">Week 5: 'King Lear': Act 5 and Tragic Conclusion</a></li>
            <li class="disabled"><a href="#">Week 6: 'King Lear' Critical Perspectives</a></li>
            <li class="disabled"><a href="#">Week 7: NEA Coursework: Proposal and Research</a></li>
            <li class="disabled"><a href="#">Week 8: NEA Coursework: Structuring Your Argument</a></li>
            <li class="disabled"><a href="#">Week 9: Critical Theory Application</a></li>
            <li class="disabled"><a href="#">Week 10: NEA Coursework: Drafting</a></li>
            <li class="disabled"><a href="#">Week 11: NEA Coursework: Peer Review and Refinement</a></li>
            <li class="disabled"><a href="#">Week 12: Autumn Assessment & Revision</a></li>
        </ul>
    </main>
    <footer>
