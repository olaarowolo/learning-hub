...
<head>
    ...
    <title>Year 13 English - Summer Term</title>
...
<body>
    <header class="year-header">
        <h1>Year 13 English - Summer Term</h1>
        <a href="/data/yeargroups/KS5/y13/subjects/english/en-index.html" class="back-link">← Back to English Home</a>
    </header>
    <main>
        <h2>Weekly Content</h2>
        <ul class="week-list">
            <li class="disabled"><a href="#">Week 1: Synoptic Revision: Connecting Texts</a></li>
            <li class="disabled"><a href="#">Week 2: Exam Technique: Paper 1 (Drama)</a></li>
            <li class="disabled"><a href="#">Week 3: Exam Technique: Paper 2 (Prose & Poetry)</a></li>
            <li class="disabled"><a href="#">Week 4: Timed Essay Practice</a></li>
            <li class="disabled"><a href="#">Week 5: Final Revision & A-Level Examinations</a></li>
            <li class="disabled"><a href="#">Week 6: A-Level Examinations</a></li>
            <li class="disabled"><a href="#">Week 7: A-Level Examinations</a></li>
            <li class="disabled"><a href="#">Week 8: A-Level Examinations</a></li>
            <li class="disabled"><a href="#">Week 9: Post-Exam Project</a></li>
            <li class="disabled"><a href="#">Week 10: Post-Exam Project</a></li>
            <li class="disabled"><a href="#">Week 11: Post-Exam Project</a></li>
            <li class="disabled"><a href="#">Week 12: End of Year</a></li>
        </ul>
    </main>
    <footer>
