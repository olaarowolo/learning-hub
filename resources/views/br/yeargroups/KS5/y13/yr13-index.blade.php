...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-13: #3f51b5; /* Indigo */
            --color-year-13-light: #6573c3;
            --theme-color: var(--color-year-13);
            --theme-color-light: var(--color-year-13-light);
            --bg-color: #f8f9fa;
            --text-dark: #343a40;
            --text-light: #6c757d;
            --card-bg: #ffffff;
...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            <h2>Subjects</h2>
            <ul id="subject-links">
                <li><a id="mathematics" href="/data/yeargroups/KS5/y13/subjects/maths/ma-index.html" class="active">Mathematics</a></li>
                <li><a id="english" href="/data/yeargroups/KS5/y13/subjects/english/en-index.html">English</a></li>
                <li><a id="science" href="/data/yeargroups/KS5/y13/subjects/science.html">Science</a></li>
                <li><a id="history" href="/data/yeargroups/KS5/y13/subjects/history.html">History</a></li>
                <li><a id="geography" href="/data/yeargroups/KS5/y13/subjects/geography.html">Geography</a></li>
                <li><a id="art" href="/data/yeargroups/KS5/y13/subjects/art.html">Art</a></li>
            </ul>
        </aside>

        <main class="content">
            <h2>Welcome to Year 13 Mathematics!</h2>
