...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            <h2>Subjects</h2>
            <ul id="subject-links">
                <li><a id="mathematics" href="/data/yeargroups/KS3/y8/subjects/maths/ma-index.html" class="active">Mathematics</a></li>
                <li><a id="english" href="/data/yeargroups/KS3/y8/subjects/eng/en-index.html">English</a></li>
                <li><a id="science" href="/data/yeargroups/KS3/y8/subjects/science.html">Science</a></li>
                <li><a id="history" href="/data/yeargroups/KS3/y8/subjects/history.html">History</a></li>
                <li><a id="coding-class" href="/data/yeargroups/KS3/y8/subjects/coding-class.html">Coding Class +</a></li>
            </ul>
        </aside>

        <main class="content">
            <h2>Welcome to Year 8!</h2>
            <p>This is your central hub for all subjects in Year 8. Use the sidebar to navigate to your desired subject and find all the learning materials you need.</p>
