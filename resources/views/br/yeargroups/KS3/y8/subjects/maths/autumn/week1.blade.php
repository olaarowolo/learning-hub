...
<head>
    ...
    <title>Week 1 - Year 8 Maths</title>
...
<body>
    <header class="year-header">
        ...
        <a href="/data/yeargroups/KS3/y8/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            ...
            <div class="assessment-details">
                <h3>📊 Year 8 Autumn Term – Week 1 Baseline Assessment</h3>
            ...
            <div class="download-links">
                <a href="/data/yeargroups/KS3/y8/subjects/maths/autumn/Year8_Autumn_Baseline_Assessment.docx.pdf" target="_blank" rel="noopener">
