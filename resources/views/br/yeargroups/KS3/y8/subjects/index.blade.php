...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><!-- Note: The main CSS is on yr8-index.html. This is for standalone viewing. -->
    <style>
        :root {
...
<body>
    <header class="year-header">
        <h1>Autumn Term</h1>
        <a href="/data/yeargroups/KS3/y8/subjects/eng/en-index.html" class="back-link">&larr; Back to Year 8 English</a>
    </header>
    <div class="container">
        <main>
            <h2>Weekly Content</h2>
            <ul class="week-list">
                <li><a href="/data/yeargroups/KS3/y8/subjects/eng/autumn/week1.html" class="week-link"><span class="week-number">Week 1</span> Introduction & Diagnostic Writing</a></li>
