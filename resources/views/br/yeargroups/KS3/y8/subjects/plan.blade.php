...
<body>
    <header class="year-header">
        ...
        <a href="/data/yeargroups/KS3/y8/english.html" class="back-link">← Back to English Home</a>
    </header>
    <main>
        <h2>Year 8 English Curriculum Plan (by Week)</h2>

        <div class="term">
            <h3>Autumn Term</h3>
            <ul>
                <li><strong>Week 1:</strong> Introduction to Year 8 English & Diagnostic Writing</li>
