...
<body>
    <header class="year-header">
        ...
        <a href="/data/yeargroups/KS3/y8/subjects/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Introduction to Year 8 English & Diagnostic Writing</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Welcome to Year 8 English! This week, we'll get to know each other and explore what English at secondary school is all about. We will also complete a short piece of writing to see your current skills.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <div class="task-box">
