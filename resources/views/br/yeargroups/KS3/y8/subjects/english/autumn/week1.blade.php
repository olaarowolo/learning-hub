...
<head>
    ...
    <title>Week 1 - Year 8 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 1 - Reading Comprehension: Summarising</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Identify the main ideas and key points in a text.</li>
                    <li>Summarise a text in your own words, focusing on the most important information.</li>
            ...
            <div class="content-section">
                ...
                <p>Summarising is a key skill in reading comprehension. It involves condensing the main ideas of a text into a shorter form without losing the essential meaning. Good summaries are concise, objective, and capture the author's main points.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Read a short story or article as a class.</li>
                    <li>Discuss the main ideas and identify supporting details.</li>
                    <li>Practice writing a group summary of the text.</li>
                    <li>Peer review summaries for clarity and completeness.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Read an article from a newspaper or online source.</li>
                    <li>Write a 100-word summary of the article.</li>
                    <li>Highlight the main ideas in your summary.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to summarise a given text accurately and concisely.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Read the provided text and identify the main idea.</li>
                    <li>Write a summary of the text in 150 words or less.</li>
                    <li>Explain why you chose to include certain details in your summary.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the reading comprehension worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Remember to review your summary and ensure it captures the essence of the text without unnecessary details.
                </div>
                <div class="info-box">
                    Good summaries are objective and use your own words to rephrase the author's ideas.
                </div>
                <div class="info-box">
                    Practice summarising different types of texts to improve your skills.
                </div>
            </div>
