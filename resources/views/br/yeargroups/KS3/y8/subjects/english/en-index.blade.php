    ...
    <link rel="stylesheet" href="/footer.css"><style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .resource-links a {
            ...
            background-color: #f1f3f5; /* A light, neutral background */
            color: var(--text-dark);
        ...
        .term-links li {
            flex: 1 1 150px; /* Allows items to grow, shrink, and wrap nicely */
        ...
        .term-links li.disabled a {
            background-color: #ced4da; /* Greyed out */
            cursor: not-allowed;
            pointer-events: none;
        }
        @media (max-width: 768px) {
...
<body>
    <header class="year-header">
        ...
        <a href="/data/yeargroups/KS3/y8/yr8-index.html" class="back-link">← Back to Year 8 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 8 English!</h2>
        <p>Year 8 English focuses on developing advanced reading, writing, speaking, and listening skills. You'll build analytical and evaluative abilities, write for various purposes and audiences, and refine your grammar, punctuation, and vocabulary through engaging activities and assessments.</p>
        <p>Our curriculum combines reading, discussion, research, drama, and extended writing tasks to help you become confident, creative communicators. You'll explore a range of texts including fiction, non-fiction, poetry, and media, while developing your ability to express ideas clearly and effectively.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS3/y8/subjects/english/plan.html">Year 8 English Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS3/y8/subjects/english/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y8/subjects/english/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y8/subjects/english/summer/">Summer Term</a></li>
        </ul>

        <h3 class="subject-title">Key Skills You'll Develop</h3>
        <ul>
            <li><strong>Reading:</strong> Analyse texts critically, identify author's techniques, themes, and viewpoints</li>
            <li><strong>Writing:</strong> Plan, draft, edit, and refine writing for different purposes and audiences</li>
            <li><strong>Grammar & Punctuation:</strong> Master complex sentence structures, punctuation, and stylistic devices</li>
            <li><strong>Speaking & Listening:</strong> Present confidently, debate effectively, and collaborate in discussions</li>
            <li><strong>Vocabulary:</strong> Build a rich vocabulary with precise word choices and figurative language</li>
        </ul>

        <h3 class="subject-title">Assessment & Progress</h3>
        <p>Throughout the year, you'll complete regular assessments to track your progress. These include reading comprehension tests, creative writing tasks, grammar exercises, and speaking presentations. Your work will be marked against clear success criteria, with opportunities for improvement and redrafting.</p>
    </main>
    <footer>
