...
<head>
    ...
    <title>Week 6 - Year 8 English</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        /* Page-specific styles for week 6 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <h1>Week 6 - Grammar: Conjunctions</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Identify and use coordinating and subordinating conjunctions correctly.</li>
                    <li>Understand the difference between coordinating and subordinating conjunctions.</li>
                    <li>Use conjunctions to create compound and complex sentences effectively.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Conjunctions are words that connect clauses, sentences, or words. Coordinating conjunctions (FANBOYS: for, and, nor, but, or, yet, so) connect equal clauses to form compound sentences. Subordinating conjunctions (because, although, when, if, etc.) connect unequal clauses to form complex sentences. Proper use of conjunctions improves sentence variety and writing flow.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Sort conjunctions into coordinating and subordinating categories.</li>
                    <li>Practice creating compound and complex sentences with different conjunctions.</li>
                    <li>Analyse conjunction use in model texts and discuss their effectiveness.</li>
                    <li>Edit sentences to improve conjunction usage and sentence variety.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write 8 compound sentences using different coordinating conjunctions.</li>
                    <li>Write 8 complex sentences using different subordinating conjunctions.</li>
                    <li>Identify the type of conjunction used in each sentence.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to use different types of conjunctions correctly in compound and complex sentences.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write four compound sentences using different coordinating conjunctions.</li>
                    <li>Write four complex sentences using different subordinating conjunctions.</li>
                    <li>Identify whether each conjunction you used is coordinating or subordinating.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the conjunctions worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Coordinating conjunctions (FANBOYS): for, and, nor, but, or, yet, so - connect equal clauses.
                </div>
                <div class="info-box">
                    Subordinating conjunctions: because, although, when, if, since, while, that - connect unequal clauses.
                </div>
                <div class="info-box">
                    Use conjunctions to vary sentence structure and improve the flow of your writing.
                </div>
            </div>
