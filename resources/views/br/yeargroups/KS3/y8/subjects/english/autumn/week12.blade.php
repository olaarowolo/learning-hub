...
<head>
    ...
    <title>Week 12 - Year 8 English</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        /* Page-specific styles for week 12 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <h1>Week 12 - Speaking and Listening: Debates</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Participate effectively in structured debates using persuasive arguments.</li>
                    <li>Research and prepare evidence-based arguments for different viewpoints.</li>
                    <li>Use rebuttal techniques and respond to counter-arguments.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Debates are structured discussions where participants present arguments for and against a proposition. Effective debaters research their topics thoroughly, present clear arguments supported by evidence, and respond thoughtfully to opposing viewpoints. Good debating skills include active listening, critical thinking, and persuasive communication.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Participate in mini-debates on familiar topics to practice basic skills.</li>
                    <li>Learn debate structures and roles (proposition team vs opposition team).</li>
                    <li>Practice rebuttal techniques and responding to counter-arguments.</li>
                    <li>Analyse famous debates to identify effective argumentation strategies.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Research a debate topic and prepare arguments for both sides.</li>
                    <li>Write a 300-word argument supporting one viewpoint with evidence.</li>
                    <li>Prepare potential rebuttals to common counter-arguments.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to participate in a structured debate with well-researched arguments and effective rebuttals.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Participate in a class debate on an assigned topic.</li>
                    <li>Present clear arguments supported by evidence and examples.</li>
                    <li>Demonstrate effective rebuttal skills when responding to opponents.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the debate skills worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Structure your arguments: Claim (main point), Evidence (facts/examples), Reasoning (explanation of how evidence supports claim).
                </div>
                <div class="info-box">
                    Use rebuttals effectively: Acknowledge opponent's point, then provide counter-evidence or show weakness in their argument.
                </div>
                <div class="info-box">
                    Stay focused and respectful: Listen actively, avoid personal attacks, and address the arguments not the person.
                </div>
            </div>
