...
<head>
    ...
    <title>Week 11 - Year 8 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 11 - Speaking and Listening: Presentations</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Deliver effective presentations with clear structure and engaging delivery.</li>
                    <li>Use verbal and non-verbal communication techniques to engage audiences.</li>
                    <li>Prepare and practice presentations with confidence and clarity.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Effective presentations combine clear content with confident delivery. A good presentation has a strong structure (introduction, main body, conclusion), engaging content, and confident delivery. Speakers should consider their audience, use appropriate language, and employ visual aids and body language to enhance their message.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Watch and analyse effective presentations to identify key techniques.</li>
                    <li>Practice delivering short presentations with peer feedback.</li>
                    <li>Learn techniques for managing presentation anxiety and building confidence.</li>
                    <li>Create and use simple visual aids to support presentations.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Prepare a 3-minute presentation on a topic of your choice.</li>
                    <li>Include an introduction, main points, and conclusion.</li>
                    <li>Practice your delivery focusing on voice, pace, and body language.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to deliver an effective presentation with clear structure and confident delivery.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Deliver a 4-minute presentation on a chosen topic.</li>
                    <li>Demonstrate clear structure, engaging content, and confident delivery.</li>
                    <li>Use appropriate verbal and non-verbal communication techniques.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the presentation skills worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Structure your presentation: Introduction (hook audience), Main body (3-5 key points), Conclusion (summarise and end strongly).
                </div>
                <div class="info-box">
                    Use the 'Tell them what you're going to tell them, tell them, tell them what you told them' approach.
                </div>
                <div class="info-box">
                    Practice your timing, use pauses for emphasis, and maintain eye contact with your audience.
                </div>
            </div>
