...
<head>
    ...
    <title>Week 4 - Year 8 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 4 - Writing Extended Narratives</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Write extended narratives with well-developed characters, plot, and setting.</li>
                    <li>Use characterisation techniques to make characters believable and engaging.</li>
                    <li>Create vivid settings and maintain consistent plot development.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Extended narratives require careful planning and development. A good story needs compelling characters with clear motivations, a well-structured plot with rising action, climax, and resolution, and vivid settings that enhance the atmosphere. Characterisation can be shown through actions, dialogue, appearance, and thoughts.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse character development in model stories and discuss characterisation techniques.</li>
                    <li>Plan narrative structures using storyboards and plot diagrams.</li>
                    <li>Practice writing character descriptions and dialogue that reveals personality.</li>
                    <li>Peer review narratives for character development and plot coherence.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write the opening 300 words of a narrative story.</li>
                    <li>Include well-developed character descriptions and setting details.</li>
                    <li>Establish the beginning of a plot with clear conflict or goal.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to write an extended narrative with developed characters and coherent plot structure.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write a 400-word narrative story about a character facing a challenge.</li>
                    <li>Include detailed characterisation showing the character's personality through actions and dialogue.</li>
                    <li>Create a vivid setting and maintain consistent plot development.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the narrative planning worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Show character development through actions, dialogue, thoughts, and appearance rather than just telling the reader.
                </div>
                <div class="info-box">
                    Use the five senses to create vivid settings that enhance the mood and atmosphere of your story.
                </div>
                <div class="info-box">
                    Plan your plot structure with a clear beginning, middle, and end to maintain reader engagement.
                </div>
            </div>
