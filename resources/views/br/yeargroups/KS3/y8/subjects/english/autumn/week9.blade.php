...
<head>
    ...
    <title>Week 9 - Year 8 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 9 - Narrative Writing: Tension</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Build and maintain tension in narrative writing through various techniques.</li>
                    <li>Use suspense, pacing, and foreshadowing to engage readers.</li>
                    <li>Create climactic moments that heighten narrative tension.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Tension is the emotional strain or suspense that keeps readers engaged in a story. Effective tension building involves creating anticipation, delaying resolutions, and using various literary techniques. Writers can build tension through short sentences, cliffhangers, foreshadowing, and the careful revelation of information to maintain reader interest.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse tension-building techniques in suspenseful stories and films.</li>
                    <li>Practice writing scenes that build tension using different techniques.</li>
                    <li>Rewrite flat scenes to increase tension and suspense.</li>
                    <li>Discuss how authors use pacing to control tension levels.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write a 300-word scene that builds tension towards a climax.</li>
                    <li>Use at least 3 different tension-building techniques.</li>
                    <li>Include foreshadowing, short sentences, and sensory details.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to build and maintain tension in narrative writing.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write a 400-word narrative scene that builds tension.</li>
                    <li>Use at least four different techniques to create suspense.</li>
                    <li>Ensure your scene has a clear build-up, climax, and resolution of tension.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the tension building worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Use short sentences to increase pace and build tension: "The door creaked. Footsteps approached. Heart pounding."
                </div>
                <div class="info-box">
                    Foreshadowing creates anticipation: hint at future events without giving them away.
                </div>
                <div class="info-box">
                    Sensory details heighten tension: describe sounds, smells, and feelings that create unease.
                </div>
            </div>
