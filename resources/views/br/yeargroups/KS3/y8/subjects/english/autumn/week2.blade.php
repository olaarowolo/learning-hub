...
<head>
    ...
    <title>Week 2 - Year 8 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 2 - Reading Comprehension: Inference</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Make inferences about characters, events, and settings based on evidence from the text.</li>
                    <li>Distinguish between what is explicitly stated and what must be inferred.</li>
                    <li>Use context clues to understand implied meanings and draw logical conclusions.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Inference is the process of drawing conclusions based on evidence and reasoning. Unlike explicit information that's directly stated in the text, inferences require you to 'read between the lines' and use your knowledge of the world to understand what the author implies. Good inferences are logical and supported by textual evidence.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Read a mystery story or extract with implied information.</li>
                    <li>Discuss what can be inferred about characters' relationships and motivations.</li>
                    <li>Practice making inferences as a group and justify them with evidence from the text.</li>
                    <li>Play inference games with picture clues and written descriptions.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Read a short story or article with implied meanings.</li>
                    <li>Write down 3 inferences you can make about the characters or events.</li>
                    <li>For each inference, provide evidence from the text to support your conclusion.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to make logical inferences and support them with textual evidence.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Read the provided text and identify one piece of information that is explicitly stated.</li>
                    <li>Make two inferences about the character's feelings or motivations.</li>
                    <li>For each inference, explain what evidence from the text supports your conclusion.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the inference worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Remember that inferences must be logical and based on evidence from the text, not just your personal opinions.
                </div>
                <div class="info-box">
                    Look for clues in the author's word choice, character actions, and descriptions to support your inferences.
                </div>
                <div class="info-box">
                    Practice distinguishing between facts (explicit) and inferences (implied) to improve your comprehension skills.
                </div>
            </div>
