...
<head>
    ...
    <title>Week 10 - Year 8 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 10 - Narrative Writing: Plot Twists</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Create effective plot twists that surprise and engage readers.</li>
                    <li>Use foreshadowing and misdirection to set up plot twists.</li>
                    <li>Ensure plot twists are believable and enhance the overall story.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Plot twists are unexpected turns in the story that change the reader's understanding of events, characters, or motivations. Effective plot twists require careful planning, subtle foreshadowing, and believable execution. They should feel surprising yet inevitable, enhancing the story's impact rather than feeling contrived or unfair to the reader.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse plot twists in famous stories and films to identify effective techniques.</li>
                    <li>Practice writing scenes with subtle foreshadowing that leads to twists.</li>
                    <li>Discuss what makes a plot twist satisfying versus frustrating.</li>
                    <li>Rewrite story endings to include effective plot twists.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write a 400-word story that includes a plot twist.</li>
                    <li>Include subtle foreshadowing that makes the twist feel earned.</li>
                    <li>Ensure the twist changes the reader's understanding of the story.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to create and execute effective plot twists in narrative writing.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write a 500-word story that builds to a surprising plot twist.</li>
                    <li>Include at least three pieces of subtle foreshadowing.</li>
                    <li>Ensure the plot twist feels believable and enhances the story's impact.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the plot twists worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Foreshadowing should be subtle: hint at possibilities without giving away the twist.
                </div>
                <div class="info-box">
                    Plot twists should feel earned: readers should be able to look back and see the clues.
                </div>
                <div class="info-box">
                    Avoid unfair twists: don't introduce new information just to create a surprise ending.
                </div>
            </div>
