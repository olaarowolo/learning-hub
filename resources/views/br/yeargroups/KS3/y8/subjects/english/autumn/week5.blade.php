...
<head>
    ...
    <title>Week 5 - Year 8 English</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        /* Page-specific styles for week 5 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <h1>Week 5 - Grammar: Complex Sentences</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Identify and use subordinating conjunctions to create complex sentences.</li>
                    <li>Distinguish between main clauses and subordinate clauses.</li>
                    <li>Construct complex sentences that add variety and sophistication to writing.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Complex sentences contain one main clause and at least one subordinate clause. They are joined by subordinating conjunctions such as 'because', 'although', 'when', 'if', 'since', 'while', and 'that'. Complex sentences allow writers to express more sophisticated ideas and create better flow in their writing.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Identify subordinating conjunctions in model texts and discuss their function.</li>
                    <li>Practice combining simple sentences into complex ones.</li>
                    <li>Analyse how complex sentences improve writing style and clarity.</li>
                    <li>Create complex sentences using different subordinating conjunctions.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write 10 complex sentences using different subordinating conjunctions.</li>
                    <li>Identify the main clause and subordinate clause in each sentence.</li>
                    <li>Explain how each complex sentence improves upon a simple sentence version.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to construct and analyse complex sentences correctly.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write five complex sentences using different subordinating conjunctions.</li>
                    <li>Identify the main clause and subordinate clause in each sentence you write.</li>
                    <li>Rewrite three simple sentences as complex sentences, explaining the improvement.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the complex sentences worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Common subordinating conjunctions: because, although, when, if, since, while, that, before, after, until, as.
                </div>
                <div class="info-box">
                    The main clause can stand alone as a complete sentence, but the subordinate clause cannot.
                </div>
                <div class="info-box">
                    Complex sentences add sophistication to writing by showing relationships between ideas.
                </div>
            </div>
