...
<head>
    ...
    <title>Week 8 - Year 8 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 8 - Punctuation: Semi-Colons</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Use semi-colons correctly to separate independent clauses and items in complex lists.</li>
                    <li>Distinguish between when to use semi-colons, colons, and commas.</li>
                    <li>Apply semi-colon rules to improve sentence variety and clarity.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Semi-colons (;) are used to connect two independent clauses that are closely related in thought. They can also be used in complex lists to separate items that contain commas. Semi-colons provide a stronger break than a comma but weaker than a full stop, allowing writers to show relationships between ideas while maintaining sentence flow.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Identify correct and incorrect uses of semi-colons in model texts.</li>
                    <li>Practice combining independent clauses with semi-colons.</li>
                    <li>Create complex lists that require semi-colons for clarity.</li>
                    <li>Compare semi-colons with other punctuation marks and discuss their effects.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write 8 sentences using semi-colons to connect related independent clauses.</li>
                    <li>Create 4 complex lists that use semi-colons to separate items.</li>
                    <li>Explain why a semi-colon is more appropriate than a comma or full stop in each case.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to use semi-colons correctly in different contexts.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write four sentences using semi-colons to connect independent clauses.</li>
                    <li>Create two complex lists using semi-colons to separate items.</li>
                    <li>Explain the difference between using a semi-colon and a comma in one of your examples.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the semi-colons worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Use semi-colons between independent clauses: "I finished my homework; then I went to bed."
                </div>
                <div class="info-box">
                    Use semi-colons in complex lists: "The conference will be held in London, England; Paris, France; and Berlin, Germany."
                </div>
                <div class="info-box">
                    Semi-colons show a stronger connection between ideas than a full stop but weaker than a comma.
                </div>
            </div>
