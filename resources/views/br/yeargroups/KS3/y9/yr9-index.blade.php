...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            <h2>Subjects</h2>
    <ul id="subject-links">
        <li><a id="mathematics" href="/data/yeargroups/KS3/y9/subjects/maths/ma-index.html">Mathematics</a></li>
        <li><a id="english" href="/data/yeargroups/KS3/y9/subjects/eng/en-index.html">English</a></li>
        <li><a id="science" href="/data/yeargroups/404.html">Science</a></li>
        <li><a id="history" href="/data/yeargroups/404.html">History</a></li>
        <li><a id="coding-class" href="/data/yeargroups/404.html">Coding Class +</a></li>
    </ul>
        </aside>

        <main class="content">
            <h2>Welcome to Year 9!</h2>
            <p>This is your central hub for all subjects in Year 9. Use the sidebar to navigate to your desired subject and find all the learning materials you need.</p>
                ...
                link.addEventListener('click', (event) => {
                    ...
                    fetch(url)
                        ...
                        .catch(error => {
                            ...
                            contentArea.innerHTML = '<iframe src="/yeargroups/404.html" width="100%" height="600" frameborder="0"></iframe>';
                        });
                });
            });
        });
