...
<head>
    ...
    <title>Week 5 - Year 9 English</title>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Construct complex sentences using subordinate clauses.</li>
                    <li>Use relative clauses to add detail and precision.</li>
                    <li>Combine ideas effectively using appropriate conjunctions.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Complex sentences allow writers to express sophisticated ideas by combining independent clauses with subordinate clauses. These sentences use subordinating conjunctions (although, because, when, if, etc.) and relative pronouns (who, which, that, etc.) to create more nuanced and detailed expressions. Mastering complex sentences improves writing clarity, sophistication, and the ability to show relationships between ideas.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Identify and analyse complex sentences in model texts.</li>
                    <li>Practice combining simple sentences into complex ones.</li>
                    <li>Create sentences using different subordinating conjunctions.</li>
                    <li>Use relative clauses to add descriptive detail.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    ...
                    <li>Include at least 3 sentences with relative clauses.</li>
                    <li>Ensure each sentence expresses a clear relationship between ideas.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to construct and use complex sentences effectively.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write five complex sentences using subordinating conjunctions.</li>
                    <li>Write three sentences using relative clauses.</li>
                    <li>Explain how complex sentences improve the clarity and sophistication of your writing.</li>
                </ol>
            </div>
            ...
            <div class="info-container">
                <div class="info-box">
                    Subordinating conjunctions: although, because, when, if, while, since, as, etc.
                </div>
                <div class="info-box">
                    Relative clauses add detail: The book that I read was fascinating.
                </div>
                <div class="info-box">
                    Complex sentences show relationships between ideas with clarity and precision.
                </div>
            </div>
