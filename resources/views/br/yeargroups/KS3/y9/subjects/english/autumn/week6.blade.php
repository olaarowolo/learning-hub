...
<head>
    ...
    <title>Week 6 - Year 9 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 6 - Grammar: Conjunctions & Stylistic Devices</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Use a range of conjunctions to create sophisticated sentence structures.</li>
                    <li>Apply stylistic devices to enhance writing effectiveness.</li>
                    <li>Choose appropriate language techniques for different purposes.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Advanced conjunctions and stylistic devices allow writers to create more sophisticated and engaging prose. Coordinating conjunctions (and, but, or, yet, so, for, nor) connect equal ideas, while correlative conjunctions (either...or, neither...nor, both...and) create balanced structures. Stylistic devices like alliteration, metaphor, and personification add depth and interest to writing when used purposefully.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Practise using correlative conjunctions in balanced sentence structures.</li>
                    <li>Identify and analyse stylistic devices in model texts.</li>
                    <li>Create sentences using alliteration, metaphor, and personification.</li>
                    <li>Discuss how stylistic devices enhance meaning and engagement.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write sentences using each type of coordinating conjunction.</li>
                    <li>Create examples of correlative conjunctions in balanced structures.</li>
                    <li>Write a short paragraph incorporating at least 3 different stylistic devices.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to use advanced conjunctions and stylistic devices effectively.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write sentences using coordinating conjunctions (and, but, or, yet, so).</li>
                    <li>Create examples using correlative conjunctions (either...or, both...and).</li>
                    <li>Write a paragraph incorporating alliteration, metaphor, and personification.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the conjunctions and stylistic devices worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                ...
                <div class="info-box">
                    Stylistic devices: alliteration, metaphor, simile, personification, hyperbole.
                </div>
            </div>
