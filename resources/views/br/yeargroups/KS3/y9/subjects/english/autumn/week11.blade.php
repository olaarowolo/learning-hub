...
<head>
    ...
    <title>Week 11 - Year 9 English</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        /* Page-specific styles for week 11 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <h1>Week 11 - Speaking & Listening: Presentations</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Plan and deliver clear, engaging presentations.</li>
                    <li>Use effective verbal and non-verbal communication skills.</li>
                    <li>Engage and persuade your audience with confidence.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Presentations are a key communication skill that involves organizing your ideas clearly and delivering them effectively to an audience. Good presentations use clear structure, engaging language, appropriate tone, and confident body language. This week focuses on developing these skills to help you communicate persuasively and professionally.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Plan presentations on assigned topics with clear introductions, main points, and conclusions.</li>
                    <li>Practice delivery focusing on voice projection, eye contact, and gestures.</li>
                    <li>Use visual aids effectively to support your message.</li>
                    <li>Peer feedback on presentation skills and areas for improvement.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Prepare a 5-minute presentation on a topic of your choice.</li>
                    <li>Record yourself delivering the presentation and evaluate your performance.</li>
                    <li>Identify strengths and areas for improvement based on self-assessment and peer feedback.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to plan and deliver effective presentations.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Deliver a 5-minute presentation on a given topic.</li>
                    <li>Use clear structure and engaging language.</li>
                    <li>Demonstrate effective verbal and non-verbal communication skills.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the presentations worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Structure presentations with clear introductions, main points, and conclusions.
                </div>
                <div class="info-box">
                    Use eye contact, gestures, and voice modulation to engage your audience.
                </div>
                <div class="info-box">
                    Practice and feedback improve confidence and delivery skills.
                </div>
            </div>
