...
<head>
    ...
    <title>Week 3 - Year 9 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 3 - Narrative Writing: Plot Development</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Structure narratives with clear beginning, middle, and end.</li>
                    <li>Develop engaging plot lines with rising action and conflict.</li>
                    <li>Use pacing techniques to maintain reader interest.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Plot development is the backbone of any narrative. A well-structured plot includes an engaging beginning that hooks the reader, a middle that builds tension through conflict and rising action, and an end that provides resolution. Effective plot development requires careful pacing, logical progression of events, and the ability to maintain reader engagement throughout the story.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse plot structures in model narratives and identify key elements.</li>
                    <li>Practice outlining story plots using storyboards or plot diagrams.</li>
                    <li>Write opening scenes that immediately engage readers.</li>
                    <li>Develop conflict and rising action in short story scenarios.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Create a plot outline for a 500-word story including beginning, middle, and end.</li>
                    <li>Ensure your plot has clear conflict and rising action.</li>
                    <li>Write the opening paragraph that hooks the reader.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to develop engaging plot structures in narrative writing.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write a 300-word story opening that establishes setting, characters, and initial conflict.</li>
                    <li>Outline the plot development for the rest of the story.</li>
                    <li>Explain how your plot structure maintains reader interest.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the plot development worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Beginning: Hook the reader, establish setting and characters, introduce initial conflict.
                </div>
                <div class="info-box">
                    Middle: Build tension through rising action, develop conflicts, show character growth.
                </div>
                <div class="info-box">
                    End: Provide resolution, tie up loose ends, leave a lasting impression.
                </div>
            </div>
