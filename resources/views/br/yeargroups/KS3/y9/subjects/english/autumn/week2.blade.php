...
<head>
    ...
    <title>Week 2 - Year 9 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 2 - Reading Comprehension: Deduction</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Identify and analyse themes and viewpoints in texts.</li>
                    <li>Use deductive reasoning to understand authorial intent.</li>
                    <li>Evaluate how different elements contribute to overall meaning.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Deduction involves using logical reasoning to reach conclusions about themes, viewpoints, and authorial intent. Unlike inference which focuses on implied meanings, deduction uses evidence from the text to draw logical conclusions about broader concepts like themes, character development, and the author's message or perspective.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse short texts to identify main themes and supporting evidence.</li>
                    <li>Discuss how different viewpoints are presented and evaluated.</li>
                    <li>Compare themes across different texts or genres.</li>
                    <li>Debate the author's intent and how it's conveyed through language choices.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Read an article or story and identify 3 main themes.</li>
                    <li>For each theme, provide evidence from the text and explain its significance.</li>
                    <li>Discuss how the author's viewpoint influences the presentation of these themes.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to identify themes and analyse viewpoints in texts.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Identify two main themes in the provided text.</li>
                    <li>Provide evidence from the text to support each theme.</li>
                    <li>Analyse how the author's viewpoint influences the presentation of these themes.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the deduction worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Themes are central ideas or messages that run through the text.
                </div>
                <div class="info-box">
                    Viewpoints can be the author's perspective or those of different characters.
                </div>
                <div class="info-box">
                    Deduction requires logical reasoning based on evidence, not just personal opinion.
                </div>
            </div>
