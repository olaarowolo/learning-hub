...
<head>
    ...
    <title>Week 10 - Year 9 English</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        /* Page-specific styles for week 10 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <h1>Week 10 - Writing Extended Narratives: Resolution</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Craft satisfying and logical story endings.</li>
                    <li>Resolve conflicts and tie up loose ends effectively.</li>
                    <li>Use language to provide closure and emotional impact.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>The resolution is the conclusion of a narrative where conflicts are resolved and the story reaches a satisfying end. A strong resolution provides closure for characters and readers, answers key questions, and leaves a lasting impression. Effective resolutions balance tying up loose ends with leaving some elements open for interpretation or future development.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse resolutions in model narratives to identify techniques used.</li>
                    <li>Write endings that resolve main conflicts and character arcs.</li>
                    <li>Discuss how language choices affect the emotional tone of the resolution.</li>
                    <li>Peer review resolutions for clarity and impact.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write a 400-word resolution for a story you have developed.</li>
                    <li>Ensure all major conflicts are resolved logically.</li>
                    <li>Use descriptive and emotive language to provide closure.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to craft effective and satisfying story resolutions.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write a 300-word story resolution that ties up loose ends.</li>
                    <li>Explain how your resolution provides closure and emotional impact.</li>
                    <li>Describe any open questions or future possibilities left by your ending.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the narrative resolution worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Resolutions provide closure and answer key story questions.
                </div>
                <div class="info-box">
                    Use emotive language to leave a lasting impression on the reader.
                </div>
                <div class="info-box">
                    Some endings may leave open questions to provoke thought or sequels.
                </div>
            </div>
