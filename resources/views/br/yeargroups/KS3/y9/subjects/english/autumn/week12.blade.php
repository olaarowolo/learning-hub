...
<head>
    ...
    <title>Week 12 - Year 9 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 12 - Speaking & Listening: Debates</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Participate effectively in structured debates.</li>
                    <li>Use evidence and reasoning to support arguments.</li>
                    <li>Respond to counter-arguments with confidence and clarity.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Debates are structured discussions where participants present arguments for and against a topic. Successful debaters use clear reasoning, evidence, persuasive language, and active listening skills. This week focuses on developing these skills to help you articulate your views effectively and engage respectfully with opposing viewpoints.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Participate in mini-debates on current topics.</li>
                    <li>Practise rebuttals and counter-arguments.</li>
                    <li>Use evidence from research to support arguments.</li>
                    <li>Focus on clear speech, confident body language, and respectful responses.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    ...
                    <li>Write a 300-word speech supporting one viewpoint.</li>
                    <li>Identify potential counter-arguments and prepare responses.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to participate effectively in a debate.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Participate in a class debate on an assigned topic.</li>
                    <li>Use evidence and reasoning to support your arguments.</li>
                    <li>Respond effectively to counter-arguments from opponents.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the debates worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                ...
                <div class="info-box">
                    Listen actively to opponents and respond respectfully.
                </div>
                <div class="info-box">
                    Prepare counter-arguments and rebuttals in advance.
                </div>
            </div>
