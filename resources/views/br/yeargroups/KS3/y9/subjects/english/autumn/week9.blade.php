...
<head>
    ...
    <title>Week 9 - Year 9 English</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        /* Page-specific styles for week 9 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <h1>Week 9 - Writing Extended Narratives: Climax</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Build tension effectively towards a story climax.</li>
                    <li>Create dramatic turning points that heighten conflict.</li>
                    <li>Use pacing techniques to maintain suspense and engagement.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>The climax is the most intense and dramatic moment in a narrative, where the main conflict reaches its peak. This is where tension is at its highest, characters face their greatest challenges, and the story's outcome hangs in the balance. Effective climaxes build gradually through rising action, create emotional impact, and set up the resolution that follows.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse climactic scenes from model narratives to identify tension-building techniques.</li>
                    <li>Write short climactic scenes focusing on character decisions and consequences.</li>
                    <li>Practise building suspense through foreshadowing and pacing.</li>
                    <li>Peer review climactic moments for emotional impact and dramatic effect.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write a 400-word climactic scene for a story of your choice.</li>
                    <li>Ensure the scene builds tension effectively and creates a dramatic turning point.</li>
                    <li>Use descriptive language and dialogue to heighten the emotional impact.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to create effective climactic moments in narrative writing.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write a 300-word climactic scene that builds tension and creates a dramatic turning point.</li>
                    <li>Explain how your writing techniques create suspense and emotional impact.</li>
                    <li>Describe how the climax affects the story's resolution.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the narrative climax worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Rising action builds tension gradually towards the climax.
                </div>
                <div class="info-box">
                    The climax is the moment of greatest conflict and emotional intensity.
                </div>
                <div class="info-box">
                    Use short sentences, sensory details, and internal monologue to heighten drama.
                </div>
            </div>
