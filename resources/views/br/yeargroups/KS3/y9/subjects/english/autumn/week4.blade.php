...
<head>
    ...
    <title>Week 4 - Year 9 English</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        /* Page-specific styles for week 4 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <h1>Week 4 - Narrative Writing: Characterisation</h1>
        <a href="/data/yeargroups/KS3/y9/subjects/english/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Create complex, believable characters with depth and motivation.</li>
                    <li>Use various techniques to reveal character traits and development.</li>
                    <li>Show character growth and change throughout a narrative.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Characterisation is the process of creating and developing characters that feel real and engaging to readers. Effective characterisation involves showing characters through their actions, dialogue, thoughts, and interactions with others, rather than simply telling readers about them. Well-developed characters have clear motivations, flaws, strengths, and undergo meaningful growth throughout the story.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse characterisation techniques in model texts and identify methods used.</li>
                    <li>Create character profiles with backgrounds, motivations, and personality traits.</li>
                    <li>Practice showing vs telling in character descriptions.</li>
                    <li>Write dialogue that reveals character personality and relationships.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Create a detailed character profile for a main character in a story.</li>
                    <li>Write a scene showing the character in action, revealing their personality through dialogue and behaviour.</li>
                    <li>Include at least three different characterisation techniques.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to create and develop complex characters in narrative writing.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Create a character profile including background, personality, and motivations.</li>
                    <li>Write a 300-word scene that reveals the character's personality through actions and dialogue.</li>
                    <li>Explain how your characterisation techniques make the character believable.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the characterisation worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Show, don't tell: Use actions, dialogue, and thoughts to reveal character traits.
                </div>
                <div class="info-box">
                    Character development: Show how characters change and grow throughout the story.
                </div>
                <div class="info-box">
                    Consistency: Ensure character actions and decisions align with their established personality.
                </div>
            </div>
