...
<head>
    ...
    <title>Week 8 - Year 9 English</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        /* Page-specific styles for week 8 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <h1>Week 8 - Punctuation: Dashes, Brackets & Ellipses</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Use dashes to add emphasis, interruptions, and additional information.</li>
                    <li>Use brackets for additional or less important information.</li>
                    <li>Use ellipses to indicate omissions, pauses, or trailing off.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Dashes, brackets, and ellipses are sophisticated punctuation marks that add nuance and emphasis to writing. Em dashes (—) create dramatic interruptions or add explanatory information. Brackets ( ) enclose supplementary information that could be omitted without affecting the main sentence. Ellipses (...) indicate pauses, omissions, or thoughts trailing off, adding subtlety to dialogue and narrative.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Practise using em dashes to add emphasis and explanatory information.</li>
                    <li>Create sentences using brackets for supplementary details.</li>
                    <li>Use ellipses in dialogue to show pauses or trailing thoughts.</li>
                    <li>Edit existing sentences to incorporate these punctuation marks effectively.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Write 5 sentences using em dashes for emphasis or explanation.</li>
                    <li>Write 5 sentences using brackets for additional information.</li>
                    <li>Write 5 sentences using ellipses to show pauses or omissions.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to use dashes, brackets, and ellipses correctly and purposefully.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Write three sentences using em dashes to add emphasis or explanation.</li>
                    <li>Write three sentences using brackets for supplementary information.</li>
                    <li>Write three sentences using ellipses to indicate pauses or omissions.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download the dashes, brackets and ellipses worksheet</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Em dash (—): Creates emphasis or adds explanatory information (e.g., "The storm—the worst in years—finally broke.").
                </div>
                <div class="info-box">
                    Brackets ( ): Enclose supplementary information (e.g., "Shakespeare (1564–1616) wrote many famous plays.").
                </div>
                <div class="info-box">
                    Ellipses (...): Indicate pauses, omissions, or trailing thoughts (e.g., "I was thinking... maybe we should try again.").
                </div>
            </div>
