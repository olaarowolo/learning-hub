...
<head>
    ...
    <title>Week 1 - Year 9 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 1 - Reading Comprehension: Inference</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <ul>
                    <li>Make accurate inferences from explicit and implicit information in texts.</li>
                    <li>Support inferences with evidence from the text.</li>
                    <li>Distinguish between what is stated and what can be inferred.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Topic Introduction</h2>
                <p>Inference is the process of drawing conclusions based on evidence and reasoning. Unlike explicit information that is directly stated, inferences require you to 'read between the lines' and use your understanding of context, character motivations, and implied meanings. Good inferences are logical and supported by textual evidence.</p>
            </div>

            <div class="content-section">
                <h2>In-Class Activities</h2>
                <ul>
                    <li>Analyse short passages to identify explicit vs implicit information.</li>
                    <li>Practice making inferences about character feelings and motivations.</li>
                    <li>Discuss how context clues help support inferences.</li>
                    <li>Peer review inferences for accuracy and evidence-based reasoning.</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Read a short story or article and make 5 inferences about characters or events.</li>
                    <li>For each inference, provide the evidence from the text that supports it.</li>
                    <li>Explain why this inference is reasonable based on the context.</li>
                </ul>
            </div>

            <div class="assessment-details">
                <h3>Assessment Details</h3>
                <p>This week's assessment focuses on your ability to make accurate inferences and support them with textual evidence.</p>

                <h4>Assessment Questions</h4>
                <ol class="question-list">
                    <li>Read the provided passage and make three inferences about the main character's personality.</li>
                    <li>For each inference, quote the specific evidence from the text that supports it.</li>
                    <li>Explain how the context helps confirm your inference.</li>
                </ol>
            </div>
            ...
            <div class="info-container">
                <div class="info-box">
                    Inference requires evidence: Always support your conclusions with specific references to the text.
                </div>
                <div class="info-box">
                    Look for context clues: Consider the setting, character actions, dialogue, and descriptions.
                </div>
                <div class="info-box">
                    Avoid assumptions: Inferences should be logical and based on what's implied, not just guessed.
                </div>
            </div>
