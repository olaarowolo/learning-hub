...
<head>
    ...
    <title>Year 9 Maths - Autumn Term</title>
...
<body>
    <header class="year-header">
        <h1>Autumn Term</h1>
        <a href="/data/yeargroups/KS3/y9/subjects/maths/ma-index.html" class="back-link">&larr; Back to Year 9 Maths</a>
    </header>
    <div class="container">
        <main>
            <h2>Weekly Content</h2>
            <ul class="week-list">
                <li><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week1.html" class="week-link"><span class="week-number">Week 1</span> Baseline Assessment</a></li>
                <li><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week2.html" class="week-link"><span class="week-number">Week 2</span> Number and Place Value</a></li>
                <li><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week3.html" class="week-link"><span class="week-number">Week 3</span> Addition & Subtraction</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week4.html" class="week-link"><span class="week-number">Week 4</span> Multiplication</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week5.html" class="week-link"><span class="week-number">Week 5</span> Division</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week6.html" class="week-link"><span class="week-number">Week 6</span> Order of Operations (BIDMAS)</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week7.html" class="week-link"><span class="week-number">Week 7</span> Factors & Multiples</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week8.html" class="week-link"><span class="week-number">Week 8</span> Primes, HCF & LCM</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week9.html" class="week-link"><span class="week-number">Week 9</span> Expressions & Equations</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week10.html" class="week-link"><span class="week-number">Week 10</span> Fractions</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week11.html" class="week-link"><span class="week-number">Week 11</span> Measures</a></li>
                <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/week12.html" class="week-link"><span class="week-number">Week 12</span> Assessment & Revision</a></li>
            </ul>
        </main>
    </div>
    <footer>
