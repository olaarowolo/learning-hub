...
<head>
    ...
    <title>Year 9 - Mathematics</title>
...
<body>
    <header class="year-header">
        <h1>Year 9 - Mathematics</h1>
        <a href="/data/yeargroups/y9/yr9-index.html" class="back-link">← Back to Year 9 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 9 Mathematics!</h2>
        <p>This is a placeholder page for Year 9 Mathematics subject content.</p>
        <p>Add notes, videos, exercises, and other learning materials here.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS3/y9/subjects/maths/plan.html">Year 9 Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS3/y9/subjects/maths/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y9/subjects/maths/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
