...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            <h2>Subjects</h2>
            <ul id="subject-links">
                <li><a id="mathematics" href="/data/yeargroups/KS3/y7/subjects/maths/ma-index.html">Mathematics</a></li>
                <li><a id="english" href="/data/yeargroups/KS3/y7/subjects/english/en-index.html">English</a></li>
                <li><a id="science" href="/data/yeargroups/KS3/y7/subjects/science.html">Science</a></li>
                <li><a id="history" href="/data/yeargroups/KS3/y7/subjects/history.html">History</a></li>
                <li><a id="geography" href="/data/yeargroups/KS3/y7/subjects/geography.html">Geography</a></li>
                <li><a id="art" href="/data/yeargroups/KS3/y7/subjects/art.html">Art</a></li>
                <li><a id="coding-class" href="/data/yeargroups/KS3/y7/subjects/coding-class.html">Coding Class +</a></li>
            </ul>
        </aside>

        <main class="content">
            <h2>Welcome to Year 7!</h2>
            <p>This is your central hub for all subjects in Year 7. Use the sidebar to navigate to your desired subject and find all the learning materials you need.</p>
