    ...
    <link rel="stylesheet" href="/footer.css"><style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .term-links { flex-direction: column; }
        }
    </style>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            ...
            <span>KS3</span> >
            <a href="/data/yeargroups/KS3/y7/yr7-index.html">Year 7</a> >
            <span>Science</span>
        </nav>
        <h1>Year 7 - Science</h1>
        <a href="/data/yeargroups/KS3/y7/yr7-index.html" class="back-link">← Back to Year 7 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 7 Science!</h2>
        <p>Explore the fascinating world of science through hands-on experiments, investigations, and theoretical learning. Develop your understanding of biology, chemistry, and physics while building essential scientific skills.</p>

        <h3 class="subject-title">Key Topics & Skills</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS3/y7/subjects/science/biology.html">Biology: Cells, Organisms & Ecosystems</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/science/chemistry.html">Chemistry: Matter, Reactions & Materials</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/science/physics.html">Physics: Forces, Energy & Space</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/science/practical-work.html">Practical Work & Investigations</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/science/working-scientifically.html">Working Scientifically</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/science/health-safety.html">Health & Safety in Science</a></li>
        </ul>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS3/y7/subjects/science/plan.html">Year 7 Science Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li class="disabled"><a href="/data/yeargroups/KS3/y7/subjects/science/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y7/subjects/science/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y7/subjects/science/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
