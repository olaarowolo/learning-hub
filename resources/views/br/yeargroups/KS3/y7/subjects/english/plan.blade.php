...
<head>
    ...
    <title>Year 7 English - Curriculum Plan</title>
...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-7: #009688; --color-year-7-light: #4db6ac;
            --theme-color: var(--color-year-7);
            --theme-color-light: var(--color-year-7-light);
...
<body>
    <header class="year-header">
        <h1>Year 7 English - Curriculum Plan</h1>
        <a href="/data/yeargroups/KS3/y7/subjects/english/en-index.html" class="back-link">← Back to English Home</a>
    </header>
    <main>
        <h2>Year 7 English Curriculum Plan (UK National Curriculum - KS3)</h2>
        <p>Year 7 English builds on KS2 skills, introducing KS3 expectations for reading, writing, and spoken language. Pupils read a range of texts, develop their writing for different purposes, and begin to analyse language and structure more deeply.</p>

        <h3>Core Aims</h3>
        <p>By the end of Year 7, pupils should be able to:</p>
        <ul>
