...
<body>
    <header class="year-header">
        ...
        <h1>Year 7 - English</h1>
        <a href="/data/yeargroups/KS3/y7/yr7-index.html" class="back-link">← Back to Year 7 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 7 English!</h2>
        <p>Develop your reading, writing, and communication skills through engaging literature, creative writing, and language analysis. Build confidence in expressing your ideas and understanding complex texts.</p>

        <h3 class="subject-title">Key Skills & Topics</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS3/y7/subjects/english/reading-comprehension.html">Reading Comprehension & Analysis</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/english/creative-writing.html">Creative Writing & Storytelling</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/english/grammar.html">Grammar & Language Structure</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/english/poetry.html">Poetry & Literary Devices</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/english/shakespeare.html">Shakespeare & Classic Literature</a></li>
            <li><a href="/data/yeargroups/KS3/y7/subjects/english/media-literacy.html">Media & Digital Literacy</a></li>
        </ul>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS3/y7/subjects/english/plan.html">Year 7 English Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS3/y7/subjects/english/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y7/subjects/english/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y7/subjects/english/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
