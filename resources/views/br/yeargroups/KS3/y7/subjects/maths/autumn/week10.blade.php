...
<head>
    ...
    <title>Week 10 - Year 7 Maths</title>
...
<body>
    <header class="year-header">
        <h1>Week 10: Fractions</h1>
        <a href="/data/yeargroups/KS3/y7/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Fractions</h2>
            
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week is all about fractions! We will learn how to simplify them, convert between different types, and perform all four operations: adding, subtracting, multiplying, and dividing. These are essential skills for many areas of maths.</p>
            </div>

            <div class="content-section">
                <h3>Key Concepts Covered</h3>
                <ul>
                    <li><strong>Simplifying Fractions:</strong> Finding the simplest form of a fraction by dividing the numerator and denominator by their highest common factor.</li>
                    <li><strong>Improper & Mixed Numbers:</strong> Converting between improper fractions (e.g., 17/5) and mixed numbers (e.g., 3 2/5).</li>
                    <li><strong>Adding & Subtracting:</strong> Finding common denominators to add and subtract fractions.</li>
                    <li><strong>Multiplying & Dividing:</strong> Learning the methods for multiplying and dividing fractions.</li>
                </ul>
            </div>
            ...
            <div class="assessment-box">
                ...
                <ol>
                    <li>Simplify: 20/28</li>
                    <li>Write 17/5 as a mixed number.</li>
                    <li>Calculate: 3/4 + 2/5</li>
                    <li>Calculate: 7/8 − 3/10</li>
                    <li>Calculate: 4/9 × 3/7</li>
                    <li>Calculate: 2/3 ÷ 5/6</li>
                    <li>A cake recipe uses 3/5 kg of flour. How much flour is needed for 4 cakes?</li>
                </ol>
            </div>

            <div class="info-box">
                <h4>📖 Homework</h4>
                <p>This week's homework will be a worksheet with mixed fraction problems to consolidate your learning.</p>
            </div>
        </main>
    </div>
    <footer>
