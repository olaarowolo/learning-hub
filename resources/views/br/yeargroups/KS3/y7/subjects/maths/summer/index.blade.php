...
<head>
    ...
    <title>Year 7 Maths - Summer Term</title>
...
<body>
    <header class="year-header">
        <h1>Year 7 Maths - Summer Term</h1>
        <a href="/data/yeargroups/KS3/y7/subjects/maths/mathematics.html" class="back-link">← Back to Maths Home</a>
    </header>
    <main>
