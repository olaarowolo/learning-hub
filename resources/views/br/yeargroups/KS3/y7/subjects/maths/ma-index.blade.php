...
<head>
    ...
    <title>Year 7 - Mathematics</title>
...
<body>
    ...
    <main>
        <h2>Welcome to Year 7 Mathematics!</h2>
        <p>This is a placeholder page for Year 7 Mathematics subject content.</p>
        <p>Add notes, videos, exercises, and other learning materials here.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS3/y7/subjects/maths/plan.html">Year 7 Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS3/y7/subjects/maths/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y7/subjects/maths/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS3/y7/subjects/maths/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
