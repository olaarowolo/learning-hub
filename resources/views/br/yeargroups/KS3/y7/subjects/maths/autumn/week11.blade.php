...
<head>
    ...
    <title>Week 11 - Year 7 Maths</title>
...
<body>
    <header class="year-header">
        <h1>Week 11: Measures</h1>
        <a href="/data/yeargroups/KS3/y7/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Measures</h2>
            
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we look at how we measure the world around us. We'll practice converting between different units of length, mass, and capacity, and learn to calculate perimeter, area, and volume for simple shapes. We'll also work with time.</p>
            </div>

            <div class="content-section">
                <h3>Key Concepts Covered</h3>
                <ul>
                    <li><strong>Metric Conversions:</strong> Converting between mm, cm, m, km; g, kg; and ml, l.</li>
                    <li><strong>Perimeter and Area:</strong> Calculating the perimeter and area of rectangles, triangles, and compound shapes.</li>
                    <li><strong>Volume:</strong> Finding the volume of cubes and cuboids.</li>
                    <li><strong>Time:</strong> Converting between 12-hour and 24-hour clocks and solving problems with timetables.</li>
                </ul>
            </div>
            ...
            <div class="assessment-box">
                ...
                <ol>
                    <li>Convert: 3.5 km = ? m.</li>
                    <li>Convert: 2.6 litres = ? ml.</li>
                    <li>Find the perimeter of a rectangle 14 cm by 9 cm.</li>
                    <li>Find the area of a triangle with base 12 cm and height 7 cm.</li>
                    <li>A cuboid measures 4 cm × 5 cm × 10 cm. Find its volume.</li>
                    <li>A train leaves at 14:35 and arrives at 17:20. How long is the journey?</li>
                    <li>A recipe for 4 people uses 250 g of sugar. How much sugar is needed for 10 people?</li>
                </ol>
            </div>

            <div class="info-box">
                <h4>📖 Homework</h4>
                <p>Your homework is to revise all the topics from this term. Use the practice questions from each week to help you prepare for the end-of-term assessment next week!</p>
            </div>
        </main>
    </div>
    <footer>
