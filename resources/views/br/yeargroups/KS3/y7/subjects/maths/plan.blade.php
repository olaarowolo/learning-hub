...
<head>
    ...
    <title>Year 7 Maths - Curriculum Plan</title>
...
<body>
    <header class="year-header">
        <h1>Year 7 Maths - Curriculum Plan</h1>
        <a href="/data/yeargroups/KS3/y7/subjects/maths/ma-index.html" class="back-link">← Back to Maths Home</a>
    </header>
    <main>
        <h2>Year 7 Mathematics Curriculum Plan (by Week)</h2>
