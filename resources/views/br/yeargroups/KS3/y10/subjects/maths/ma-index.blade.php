...
<meta name="msapplication-square310x310logo" content="/favicons/ms-icon-310x310.png">
    ...
    <link rel="stylesheet" href="/footer.css"><style>
        :root {
            --color-year-10: #607d8b; --color-year-10-light: #90a4ae;
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            ...
            <span>KS3</span> >
            <a href="/data/yeargroups/KS3/y10/yr10-index.html">Year 10</a> >
            <span>Maths</span>
        </nav>
    ...
    <main>
        ...
        <p>Explore the world of numbers, shapes, and problem-solving. Use the links below to navigate through the curriculum and term content.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS3/y10/subjects/maths/plan.html">Year 10 Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li class="disabled"><a href="#">Autumn Term</a></li>
            <li class="disabled"><a href="#">Spring Term</a></li>
            <li class="disabled"><a href="#">Summer Term</a></li>
        </ul>
    </main>
    <footer>
