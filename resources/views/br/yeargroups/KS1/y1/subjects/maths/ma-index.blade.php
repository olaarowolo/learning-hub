...
<head>
    ...
    <title>Year 1 - Mathematics</title>
...
<body>
    <header class="year-header">
        ...
        <h1>Year 1 - Mathematics</h1>
        <a href="/data/yeargroups/KS1/y1/yr1-index.html" class="back-link">← Back to Year 1 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 1 Mathematics!</h2>
        <p>Explore numbers, shapes, and patterns in a fun and engaging way. Use the links below to navigate through the curriculum and term content.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS1/y1/subjects/maths/plan.html">Year 1 Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS1/y1/subjects/maths/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS1/y1/subjects/maths/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS1/y1/subjects/maths/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
