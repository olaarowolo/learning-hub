...
<body>
    <header class="year-header">
        <h1>Year 1 - History</h1>
        <a href="/data/yeargroups/KS1/y1/yr1-index.html" class="back-link">← Back to Year 1 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 1 History!</h2>
        <p>Get ready to explore pivotal moments in history. Content on past eras, significant events, and historical analysis is coming soon!</p>
