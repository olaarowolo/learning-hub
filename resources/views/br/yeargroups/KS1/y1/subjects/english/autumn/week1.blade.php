...
<head>
    ...
    <title>Week 1 - Year 1 English</title>
...
<body>
    <header class="year-header">
        <h1>Week 1 - Phonics (Phase 3) - Letter Sounds</h1>
    ...
    <div class="container">
        <main>
            <div class="content-section">
                ...
                <p>Introduce and practice Phase 3 phonics, focusing on letter sounds and initial blending.</p>
            </div>

            <div class="content-section">
                <h2>Activities</h2>
                <ul>
                    <li>Sound games: Identify and practice individual letter sounds.</li>
                    <li>Picture matching: Match pictures to initial sounds.</li>
                    <li>Group activities: Sound bingo or sound hunts around the classroom.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Homework</h2>
                <p>Practice saying the sounds of letters A-Z at home. Bring a favorite toy and tell us its initial sound.</p>
            </div>

            <div class="assessment-details">
                <h3>Practice Questions</h3>
                <ol class="question-list">
                    <li>What sound does the letter 'B' make?</li>
                    <li>Find objects in your home that start with 'S'.</li>
                    <li>Write the letter that makes the /k/ sound.</li>
                </ol>
            </div>
            ...
            <div class="download-links">
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
                    ...
                    <span>Download Phonics Sound Cards</span>
                </a>
                <a href="#" class="disabled" target="_blank" rel="noopener" tabindex="-1" aria-disabled="true">
            ...
            <div class="info-container">
                <div class="info-box">
                    Remember to practice your sounds daily to build confidence in reading!
                </div>
                <div class="info-box">
                    Phonics is the foundation of reading. Keep practicing and have fun with sounds!
                </div>
            </div>

            <div class="solution-request">
                If you need help with phonics, please ask your teacher or use this link: <a href="#" target="_blank">Phonics Help</a>.
            </div>
