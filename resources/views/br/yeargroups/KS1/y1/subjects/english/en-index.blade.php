...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" style="position: absolute; top: 1rem; left: 50%; transform: translateX(-50%); color: white; font-size: 14px;">
            ...
            <a href="/data/yeargroups/" style="color: white; text-decoration: none;">Year Groups</a> >
            <a href="/data/yeargroups/KS1/" style="color: white; text-decoration: none;">KS1</a> >
            <a href="/data/yeargroups/KS1/y1/" style="color: white; text-decoration: none;">Year 1</a> >
            <a href="/data/yeargroups/KS1/y1/subjects/" style="color: white; text-decoration: none;">Subjects</a> >
            <span>English</span>
        </nav>
        <h1>Year 1 - English</h1>
        <a href="/data/yeargroups/KS1/y1/subjects/yr1-index.html" class="back-link">← Back to Year 1 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 1 English!</h2>
        <p>Explore the world of literature, enhance your writing skills, and become a master of language. Use the links below to navigate through the curriculum and term content.</p>

        <h3 class="subject-title">Curriculum Resources</h3>
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS1/y1/subjects/english/plan.html">Year 1 English Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS1/y1/subjects/english/autumn/">Autumn Term</a></li>
            <li><a href="/data/yeargroups/KS1/y1/subjects/english/spring/">Spring Term</a></li>
            <li><a href="/data/yeargroups/KS1/y1/subjects/english/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
