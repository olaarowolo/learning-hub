...
<body>
    <header class="year-header">
        <h1>Year 1 - Geography</h1>
        <a href="/data/yeargroups/KS1/y1/yr1-index.html" class="back-link">← Back to Year 1 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 1 Geography!</h2>
        <p>Prepare to explore the world. Content on physical landscapes, human geography, and environmental issues will be available shortly.</p>
