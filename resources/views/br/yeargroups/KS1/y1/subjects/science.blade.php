...
<body>
    <header class="year-header">
        <h1>Year 1 - Science</h1>
        <a href="/data/yeargroups/KS1/y1/yr1-index.html" class="back-link">← Back to Year 1 Home</a>
    </header>
    <main>
        <h2>Welcome to Year 1 Science!</h2>
        <p>Content for Biology, Chemistry, and Physics will be available here soon. Stay tuned for exciting experiments and in-depth topic explorations!</p>
