...
<head>
    ...
    <title>Year 2 - Mathematics</title>
...
<body>
    <header class="year-header">
        <h1>Year 2 - Mathematics</h1>
        <a href="/data/yeargroups/y2/yr2-index.html" class="back-link">← Back to Year 2 Home</a>
    </header>
    <main>
        ...
        <ul class="resource-links">
            <li><a href="/data/yeargroups/KS1/y2/subjects/maths/plan.html">Year 2 Maths Curriculum Plan</a></li>
        </ul>

        <h3 class="subject-title">Term Content</h3>
        <ul class="term-links">
            <li><a href="/data/yeargroups/KS1/y2/subjects/maths/autumn/">Autumn Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS1/y2/subjects/maths/spring/">Spring Term</a></li>
            <li class="disabled"><a href="/data/yeargroups/KS1/y2/subjects/maths/summer/">Summer Term</a></li>
        </ul>
    </main>
    <footer>
