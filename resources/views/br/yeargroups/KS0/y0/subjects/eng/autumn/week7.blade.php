...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 7</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 7</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 7</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Phonics: 'g', 'o', 'c', 'k'</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Let's learn more sounds! This week we are focusing on 'g', 'o', 'c', and 'k'. We will see that 'c' and 'k' can make the same sound!</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Practice writing the new letters. Go on a sound hunt for objects starting with 'g', 'o', 'c', or 'k'. Use your letter cards to build new words like 'dog', 'cot', 'kid'.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Phonics: g, o, c, k</h3>
                <p>These sounds help us read and write even more words.</p>
                <ul>
                    <li><strong>g</strong> as in <strong>g</strong>oat</li>
                    <li><strong>o</strong> as in <strong>o</strong>ctopus</li>
                    <li><strong>c</strong> as in <strong>c</strong>at</li>
                    <li><strong>k</strong> as in <strong>k</strong>ing</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>What sound does 'g' make?</li>
                    <li>Can you read this word: 'c-o-t'? (cot)</li>
                    <li>Which two letters can make the /k/ sound? ('c' and 'k')</li>
                    <li>Try to write the word 'dog'.</li>
                    <li>Blend the sounds to read 'kid'.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_Phonics_gock_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download 'g, o, c, k' phonics worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Remember: 'c' often comes before 'a', 'o', 'u'. 'k' often comes before 'i', 'e'.
                </div>
                <div class="info-box">
                    Play a game of 'Buried Treasure' with real and nonsense words (e.g., 'dog' is real, 'kog' is nonsense).
                </div>
                <div class="info-box">
                    Practice writing the letters in different fun ways - with chalk, in sand, or with water on a paintbrush outside.
                </div>
            </div>
