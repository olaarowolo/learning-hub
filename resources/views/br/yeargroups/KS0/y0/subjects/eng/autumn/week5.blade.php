...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 5</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 5</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 5</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Story Time: "The Very Hungry Caterpillar"</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we will dive into the wonderful story of "The Very Hungry Caterpillar" by Eric Carle. We will listen to the story, talk about the characters, and explore the journey of the caterpillar.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Listen to the story several times. Talk about what the caterpillar ate each day. Draw your favorite part of the story. Try to retell the story in your own words.</p>
            </div>
            <div class="assessment-details">
                <h3>🐛 The Very Hungry Caterpillar</h3>
                <p>This classic story helps us learn about:</p>
                <ul>
                ...
                <ol class="question-list">
                    <li>What did the caterpillar eat on Monday? (One apple)</li>
                    <li>How did the caterpillar feel after eating all the food on Saturday? (He had a stomach ache)</li>
                    <li>What did the caterpillar build around himself? (A cocoon)</li>
                    <li>What did he turn into at the end of the story? (A beautiful butterfly)</li>
                    <li>Draw a picture of the big, fat caterpillar.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_HungryCaterpillar_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download story activity worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Act out the story! Pretend to be the hungry caterpillar nibbling through food.
                </div>
                <div class="info-box">
                    Make a food diary for the caterpillar, drawing what he ate each day.
                </div>
                <div class="info-box">
                    Create your own butterfly painting with bright, beautiful colors.
                </div>
            </div>
