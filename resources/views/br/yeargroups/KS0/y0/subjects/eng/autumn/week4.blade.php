...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 4</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 4</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 4</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Tricky Words: 'I', 'the', 'to'</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Some words are a bit tricky! We can't sound them out using our phonics. We just have to learn to recognize them. This week, we will learn our first three tricky words: 'I', 'the', and 'to'.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Go on a 'tricky word hunt' in your reading books. Practice writing the words. Try to make a simple sentence using one of the words, like "I go to the park."</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Tricky Words (Phase 2)</h3>
                <p>These words are also called 'common exception words'.</p>
                <ul>
                    <li><strong>I</strong> (Always a capital letter when it means you!)</li>
                ...
                <ol class="question-list">
                    <li>Can you find the word 'the' on this page?</li>
                    <li>Write the word 'I' three times.</li>
                    <li>Read this sentence: "I go to the shop."</li>
                    <li>Fill in the blank: "I want __ go home." (to)</li>
                    <li>Try writing 'the' from memory.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_TrickyWords1_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download tricky words worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Write the tricky words on flashcards and stick them around the house.
                </div>
                <div class="info-box">
                    Use them in your writing as much as possible.
                </div>
                <div class="info-box">
                    Play 'splat the word' - write the words on paper, call one out, and your child has to splat it!
                </div>
            </div>
