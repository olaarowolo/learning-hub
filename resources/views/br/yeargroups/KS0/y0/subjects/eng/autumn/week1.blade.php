...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 1</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 1</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 1</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Introduction to Phonics: 's', 'a', 't', 'p'</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Welcome to the first week of English! We are starting our phonics journey by learning the first set of sounds: 's', 'a', 't', and 'p'. We will learn to recognize the letters and say their sounds.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Practice saying the sounds. Go on a sound hunt around the room for things that start with 's', 'a', 't', or 'p'. Try writing the letters in sand, paint, or on a whiteboard.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Phonics: s, a, t, p</h3>
                <p>These are the first sounds we learn. They are very common in words.</p>
                <ul>
                    <li><strong>s</strong> as in <strong>s</strong>un</li>
                    <li><strong>a</strong> as in <strong>a</strong>pple</li>
                    <li><strong>t</strong> as in <strong>t</strong>en</li>
                    <li><strong>p</strong> as in <strong>p</strong>ig</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>What sound does the letter 's' make?</li>
                    <li>Can you find something in the room that starts with 't'?</li>
                    <li>Let's try to blend sounds: what word does 'a' - 't' make? (at)</li>
                    <li>Practice writing the letter 'a'.</li>
                    <li>Sing the alphabet song up to 'p'.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_Phonics_satp_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download 's, a, t, p' phonics worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Use magnetic letters to build simple words like 'at', 'sat', 'pat', 'tap'.
                </div>
                <div class="info-box">
                    Sing alphabet and phonics songs to make learning fun.
                </div>
                <div class="info-box">
                    Practice makes perfect! A little bit of phonics every day helps a lot.
                </div>
            </div>
