...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 12</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 12</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 12</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Christmas-Themed Stories and Writing</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>It's nearly Christmas! This week, we will read festive stories, sing Christmas songs, and do some fun Christmas-themed writing activities to celebrate the season.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Read a Christmas story like "The Snowman" or "Stick Man". Write a letter to Santa. Make a Christmas card for your family and write your name inside.</p>
            </div>
            <div class="assessment-details">
                <h3>🎄 Christmas Fun!</h3>
                <p>Let's use all the English skills we have learned this term.</p>
                <ul>
                    <li>Listen to and talk about Christmas stories.</li>
                    <li>Write a list of presents you would like.</li>
                    <li>Use your phonics to write festive words like 'elf', 'red', 'sack'.</li>
                    <li>Sing Christmas carols and rhymes.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Draw a picture of a snowman and write the word 'snowman'.</li>
                    <li>What would you ask Santa for? Try to write one word.</li>
                    <li>Make a Christmas card and decorate it.</li>
                    <li>Listen to 'Jingle Bells' and clap along.</li>
                    <li>Tell someone what your favorite thing about Christmas is.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_ChristmasWriting_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download Christmas activity worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Share a favorite Christmas book together as a family.
                </div>
                <div class="info-box">
                    Writing a letter to Santa is great practice for using phonics and writing your name.
                </div>
                <div class="info-box">
