...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 10</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 10</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 10</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Story Sequencing</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we will learn to put the events of a story in the correct order. This is called sequencing. It helps us to understand and retell stories.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>After reading a familiar story like 'The Three Little Pigs', use picture cards to put the main events in order. Try drawing your own pictures for a story and putting them in order.</p>
            </div>
            <div class="assessment-details">
                <h3>📖 Story Sequencing</h3>
                <p>We use words like 'first', 'next', 'then', and 'finally' to help us order a story.</p>
                <ul>
                    <li><strong>First,</strong> the wolf came to the straw house.</li>
                    <li><strong>Next,</strong> he blew it down.</li>
                    <li><strong>Then,</strong> he went to the stick house.</li>
                    <li><strong>Finally,</strong> he couldn't blow down the brick house.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>What happens at the beginning of 'Goldilocks and the Three Bears'?</li>
                    <li>What happens at the end?</li>
                    <li>Look at three pictures from a story. Which one comes first?</li>
                    <li>Tell a friend how to brush their teeth, using 'first', 'next', and 'then'.</li>
                    <li>Draw three pictures to show the beginning, middle, and end of your school day.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_StorySequencing_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download story sequencing worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Use story maps or story mountains to visually plan the sequence of a story.
                </div>
                <div class="info-box">
                    Act out simple stories to help remember the order of events.
                </div>
                <div class="info-box">
                    Take photos of an activity (like baking a cake) and put them in order.
                </div>
            </div>
