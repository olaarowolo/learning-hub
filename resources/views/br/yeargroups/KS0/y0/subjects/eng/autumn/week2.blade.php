...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 2</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 2</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 2</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Phonics: 'i', 'n', 'm', 'd'</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week we are learning four more sounds: 'i', 'n', 'm', and 'd'. We will practice saying them and start to blend them with the sounds we learned last week to read new words.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Use letter cards to make CVC (consonant-vowel-consonant) words like 'pin', 'din', 'sit', 'pan'. Try writing the new letters and words.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Phonics: i, n, m, d</h3>
                <p>With these new sounds, we can make lots of words!</p>
                <ul>
                    <li><strong>i</strong> as in <strong>i</strong>gloo</li>
                    <li><strong>n</strong> as in <strong>n</strong>et</li>
                    <li><strong>m</strong> as in <strong>m</strong>an</li>
                    <li><strong>d</strong> as in <strong>d</strong>og</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>What sound does 'm' make?</li>
                    <li>Can you read this word: 'p-a-n'? (pan)</li>
                    <li>Can you write the letter 'd'?</li>
                    <li>Find something in a book that starts with the 'n' sound.</li>
                    <li>Let's make a silly word: 'mip'. Can you sound it out?</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_Phonics_inmd_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download 'i, n, m, d' phonics worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Play 'I Spy' using the letter sounds you know. "I spy with my little eye, something beginning with 'd'."
                </div>
                <div class="info-box">
                    Use play-doh to form the letters you are learning.
                </div>
                <div class="info-box">
                    Reading together every day helps build confidence with new sounds.
                </div>
            </div>
