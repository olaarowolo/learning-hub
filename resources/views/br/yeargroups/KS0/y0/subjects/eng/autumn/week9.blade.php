...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 9</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 9</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 9</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Phonics: 'ck', 'e', 'u', 'r'</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week we learn our first digraph: 'ck'. A digraph is two letters that make one sound. We will also learn the sounds for 'e', 'u', and 'r'.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Practice reading and writing words with 'ck' at the end, like 'duck', 'sock', 'kick'. Build words with the new sounds, such as 'run', 'red', 'sun'.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Phonics: ck, e, u, r</h3>
                <p>The 'ck' sound usually comes at the end of words.</p>
                <ul>
                    <li><strong>ck</strong> as in du<strong>ck</strong></li>
                    <li><strong>e</strong> as in <strong>e</strong>gg</li>
                    <li><strong>u</strong> as in <strong>u</strong>mbrella</li>
                    <li><strong>r</strong> as in <strong>r</strong>obot</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>How many letters in the digraph 'ck'? (Two) How many sounds? (One)</li>
                    <li>Read this word: 'r-u-n'. (run)</li>
                    <li>Can you write the word 'sock'?</li>
                    <li>What sound does the letter 'e' make?</li>
                    <li>Find a word in your book that ends with 'ck'.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_Phonics_ckeur_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download 'ck, e, u, r' phonics worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Go on a 'ck' hunt! Look for words with 'ck' in books or around the house.
                </div>
                <div class="info-box">
                    The vowels we have learned so far are 'a', 'e', 'i', 'o', 'u'.
                </div>
                <div class="info-box">
                    Practice writing short sentences with the words you can now read, e.g., "A red sock."
                </div>
            </div>
