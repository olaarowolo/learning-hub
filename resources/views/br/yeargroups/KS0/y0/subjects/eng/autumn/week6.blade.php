...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 6</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 6</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 6</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Mark Making and Early Writing</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Writing starts with making marks! This week, we will encourage children to make marks, draw, and begin to form recognizable letters. This builds the muscle control and confidence needed for writing.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Use different tools for mark making: chalk outside, paint with fingers, use chunky crayons, or write in a tray of sand or flour. Practice writing the letters in your name.</p>
            </div>
            <div class="assessment-details">
                <h3>✍️ Mark Making</h3>
                <p>Any mark is a great start! It can be a line, a circle, or a squiggle. It's all about communicating ideas.</p>
                <ul>
                    <li>Encourage children to talk about their drawings.</li>
                    <li>Show them how to hold a pencil correctly (tripod grip).</li>
                    <li>Practice forming letters from the phonics sounds we have learned.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Draw a picture of your family.</li>
                    <li>Can you write the first letter of your name?</li>
                    <li>Practice writing the letters 's' and 'a'.</li>
                    <li>Draw lines, circles, and zig-zags.</li>
                    <li>Try to write a simple CVC word you know, like 'cat' or 'sun'.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_MarkMaking_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download mark making and writing practice worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Make writing fun! Don't worry about it being perfect.
                </div>
                <div class="info-box">
                    Praise all attempts at writing, even if it's just a scribble.
                </div>
                <div class="info-box">
                    Ask your child to "write" a shopping list or a letter to a friend.
                </div>
            </div>
