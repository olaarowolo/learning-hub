...
<head>
    ...
    <title>Year 0 English Spring Term - Week 1</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/spring/index.html">Spring Term</a> > <span>Week 1</span>
        </nav>
        <h1>Year 0 English Spring Term - Week 1</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/spring/index.html" class="back-link">&larr; Back to Spring Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Phonics Phase 3: 'j', 'v', 'w', 'x'</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Welcome to the Spring Term! We are moving on to Phase 3 phonics. This week, we will learn four new sounds: 'j', 'v', 'w', and 'x'.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Practice saying the new sounds. Try writing the letters. Can you think of any words that have these sounds in them? For example, 'jet' or 'box'.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Phonics: j, v, w, x</h3>
                <p>These sounds are exciting additions to our phonics knowledge.</p>
                <ul>
                    <li><strong>j</strong> as in <strong>j</strong>am</li>
                    <li><strong>v</strong> as in <strong>v</strong>an</li>
                    <li><strong>w</strong> as in <strong>w</strong>eb</li>
                    <li><strong>x</strong> as in bo<strong>x</strong></li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>What sound does the letter 'j' make?</li>
                    <li>Can you write the letter 'w'?</li>
                    <li>Read this word: 'j-e-t'. (jet)</li>
                    <li>The 'x' sound often comes at the end of words. Can you think of one? (fox, box, six)</li>
                    <li>Let's write a word with 'v': 'van'.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/spring/Year0_Spring_Phonics_jvwx_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download 'j, v, w, x' phonics worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Practice writing the letters in the air with your 'magic finger'.
                </div>
                <div class="info-box">
                    Look for these new letters in storybooks you read together.
                </div>
                <div class="info-box">
                    Use your phonics cards to build new words like 'jam', 'wet', and 'van'.
                </div>
            </div>
