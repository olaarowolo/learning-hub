...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 11</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Page-specific styles for week 2 can go here if needed */
        .content-section {
            margin-bottom: 2rem;
        }
        .assessment-details {
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 11</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 11</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Phonics: 'h', 'b', 'f', 'ff', 'l', 'll', 'ss'</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>We are learning more sounds and some new digraphs this week! We will look at 'h', 'b', 'f', and the 'double letter' digraphs 'ff', 'll', and 'ss'.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Practice reading words with these new sounds, like 'hat', 'bed', 'fun'. Look for words with 'ff', 'll', and 'ss' at the end, like 'puff', 'hill', and 'miss'.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Phonics: h, b, f, ff, l, ll, ss</h3>
                <p>The digraphs ff, ll, and ss often appear at the end of short words after a single vowel.</p>
                <ul>
                    <li><strong>h</strong> as in <strong>h</strong>at, <strong>b</strong> as in <strong>b</strong>us, <strong>f</strong> as in <strong>f</strong>an</li>
                    <li><strong>ff</strong> as in pu<strong>ff</strong>, <strong>ll</strong> as in hi<strong>ll</strong>, <strong>ss</strong> as in ki<strong>ss</strong></li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Read the word: 'h-u-ff'. (huff)</li>
                    <li>Can you write the word 'bell'?</li>
                    <li>What sound does 'b' make?</li>
                    <li>Find a word in your book that has 'ss' at the end.</li>
                    <li>Segment the word 'fluff' into its sounds. (f-l-u-ff)</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_Phonics_hbfllss_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download 'h, b, f, ff, l, ll, ss' phonics worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    This is often called the 'Floss Rule' - if a short word ends in /f/, /l/, or /s/ after one vowel, you usually double the consonant.
                </div>
                <div class="info-box">
                    Play matching games with pictures and words (e.g., picture of a bell and the word 'bell').
                </div>
                <div class="info-box">
                    Write the words in big letters and go over them with your finger to remember the shape.
                </div>
            </div>
