...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 3</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 3</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 3</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Blending and Segmenting CVC Words</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week is all about putting our sounds together to read words (blending) and breaking words up to spell them (segmenting). We will focus on simple CVC (Consonant-Vowel-Consonant) words.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Use "robot arms" to sound out words like c-a-t. Use sound buttons under words to help with blending. Try writing simple CVC words from pictures.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Blending and Segmenting</h3>
                <p>Blending is for reading. Segmenting is for spelling.</p>
                <ul>
                    <li><strong>Blending:</strong> Hearing 'c-a-t' and saying 'cat'.</li>
                    <li><strong>Segmenting:</strong> Hearing 'cat' and saying 'c-a-t' to write it.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Blend these sounds: 's-i-t'. What is the word? (sit)</li>
                    <li>How many sounds are in the word 'tin'? (3: t-i-n)</li>
                    <li>Can you write the word 'pat'?</li>
                    <li>Look at a picture of a dog. Can you segment the sounds? (d-o-g)</li>
                    <li>Read the word: 'map'.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_CVC_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download CVC words worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Make it a game! How many CVC words can you make with your letter cards in one minute?
                </div>
                <div class="info-box">
                    Look for CVC words in your reading books.
                </div>
                <div class="info-box">
                    Drawing a picture for each word you write can help with memory.
                </div>
            </div>
