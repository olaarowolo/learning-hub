...
<head>
    ...
    <title>Year 0 English Autumn Term - Week 8</title>
...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <a href="/data/yeargroups/KS0/y0/yr0-index.html">Year 0</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/en-index.html">English</a> > <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html">Autumn Term</a> > <span>Week 8</span>
        </nav>
        <h1>Year 0 English Autumn Term - Week 8</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Rhyming Words</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week is all about having fun with words that sound the same at the end. These are called rhyming words! Listening for rhymes is an important skill for reading and writing.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Read rhyming books and poems. Play rhyming games like 'I spy a word that rhymes with cat...'. Make up silly rhyming strings (e.g., cat, hat, sat, mat, pat).</p>
            </div>
            <div class="assessment-details">
                <h3>👂 Listening for Rhymes</h3>
                <p>Rhyming words have the same ending sound.</p>
                <ul>
                    <li>cat / hat</li>
                    <li>dog / log</li>
                    <li>sun / run</li>
                ...
                <ol class="question-list">
                    <li>Does 'pig' rhyme with 'dig'? (Yes)</li>
                    <li>Can you think of a word that rhymes with 'pen'? (hen, ten)</li>
                    <li>Which word is the odd one out: 'fan', 'pan', 'dog'? (dog)</li>
                    <li>Finish the rhyme: "Twinkle, twinkle, little..." (star)</li>
                    <li>Listen to a rhyming story and clap when you hear a rhyme.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/eng/autumn/Year0_Autumn_Rhyming_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download rhyming words worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Sing lots of nursery rhymes! They are full of rhyming words.
                </div>
                <div class="info-box">
                    Read books by authors like Julia Donaldson, who is a master of rhyme.
                </div>
                <div class="info-box">
                    Make a rhyming basket. Put in pairs of objects that rhyme (e.g., a toy car and a star).
                </div>
            </div>
