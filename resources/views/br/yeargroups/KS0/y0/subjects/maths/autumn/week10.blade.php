...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 10</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 10</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: 2D and 3D Shapes</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week we will look at shapes again, but this time we will learn the difference between flat (2D) shapes and solid (3D) shapes.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Go on a shape hunt to find 2D and 3D shapes. Build models with 3D shapes and talk about their properties.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 2D and 3D Shapes</h3>
                <p>2D shapes are flat, like a drawing on paper. 3D shapes are solid and you can hold them.</p>
                <ul>
                    <li>2D Shapes: Circle, Square, Triangle, Rectangle</li>
                    <li>3D Shapes: Sphere (ball), Cube (dice), Cuboid (box), Cylinder (can)</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Is a piece of paper 2D or 3D? (2D)</li>
                    <li>Is a ball a sphere or a circle? (Sphere)</li>
                    <li>Find a cube in the room (e.g., a dice, a block).</li>
                    <li>What 3D shape is a can of soup? (Cylinder)</li>
                    <li>Build a tower using different 3D blocks.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_3DShapes_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download 2D and 3D shapes worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    A cube has square faces. A cuboid can have square and rectangle faces.
                </div>
                <div class="info-box">
                    A sphere is perfectly round like a ball.
                </div>
                <div class="info-box">
                    Talk about whether shapes can roll or stack.
                </div>
            </div>
