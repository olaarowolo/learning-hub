...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 1</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 1</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Counting and Number Recognition</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week focuses on basic counting skills and recognizing numbers up to 10. Counting helps children understand quantity and develop early mathematical concepts.</p>
                <p>Children will learn to count objects, recognize numerals, and match numbers to quantities.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Practice counting objects using fingers, toys, or pictures. Recognize numbers 1-10 and match them to groups of items.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Counting and Number Recognition</h3>
                <p>Counting is the process of determining the number of elements in a set. For example, counting apples in a basket.</p>
                <ul>
                    <li>Count objects one by one.</li>
                    <li>Say the numbers in order: 1, 2, 3...</li>
                    <li>Recognize the last number as the total.</li>
                </ul>

                <h4>🔹 Number Recognition</h4>
                <p>Numbers are symbols that represent quantities. Learn to identify and name numbers 1-10.</p>
                <p>Examples:</p>
                <ul>
                    <li>1 - one apple</li>
                    <li>2 - two balls</li>
                ...
                <h4>🔹 Matching Numbers to Quantities</h4>
                <p>Match the correct number to the right amount of objects.</p>
                <p>Examples:</p>
                <ul>
                    <li>Picture of 4 stars matches the number 4</li>
                    <li>Group of 5 toys matches the number 5</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Count the apples in the picture and say the number.</li>
                    <li>Point to the number 3.</li>
                    <li>How many fingers are you holding up? (Show 2)</li>
                    <li>Draw 4 circles.</li>
                    <li>Which group has more? (Show groups of 3 and 5)</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Counting_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download counting worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Counting is fun! Use toys or everyday objects to practice.
                </div>
                <div class="info-box">
                    Sing counting songs to help remember the numbers.
                </div>
                <div class="info-box">
                    Ask your teacher or parent for help if you need more practice.
                </div>
            </div>
