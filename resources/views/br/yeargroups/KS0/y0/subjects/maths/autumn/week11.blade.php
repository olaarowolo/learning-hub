...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 11</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 11</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Numbers 9 and 10</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>We are reaching a big number! This week is all about 9 and 10. We will practice counting and recognizing these numbers, using all our fingers!</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Count up to 10 using fingers on both hands. Find groups of 9 and 10 objects. Practice writing the numerals 9 and 10.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Numbers 9 and 10</h3>
                <p>Nine (9) and Ten (10) are the last single-digit numbers we will learn for a while!</p>
                <ul>
                    <li>We have 10 fingers and 10 toes.</li>
                    <li>A nonagon is a shape with 9 sides.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Show me 9 fingers.</li>
                    <li>Count to 10 out loud.</li>
                    <li>Draw a picture with 10 flowers.</li>
                    <li>Find a group of 9 pencils.</li>
                    <li>Write the numbers 9 and 10.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Numbers910_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download numbers 9 and 10 worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    "Ten Green Bottles" is a great song for counting down from 10.
                </div>
                <div class="info-box">
                    Use two hands to show numbers up to 10.
                </div>
                <div class="info-box">
                    Practice writing 9 (make a loop and a line) and 10 (a 1 and a 0).
                </div>
            </div>
