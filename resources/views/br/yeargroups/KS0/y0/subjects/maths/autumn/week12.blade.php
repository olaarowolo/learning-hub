...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 12</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 12</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Counting and Number Bonds to 10</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we will practice all our numbers up to 10 and explore 'number bonds' - the pairs of numbers that make 10. This is a key skill for addition.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Use a ten-frame to show number bonds. Play games with number bonds to 10. Practice counting forwards and backwards to 10.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Counting and Number Bonds to 10</h3>
                <p>Number bonds are pairs of numbers that add up to another number. Knowing the number bonds to 10 is very useful!</p>
                <ul>
                    <li>1 and 9 make 10</li>
                    <li>2 and 8 make 10</li>
                    <li>3 and 7 make 10</li>
                    <li>4 and 6 make 10</li>
                    <li>5 and 5 make 10</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>If you have 6, how many more do you need to make 10? (4)</li>
                    <li>What goes with 8 to make 10? (2)</li>
                    <li>Use your fingers to show how 7 and 3 make 10.</li>
                    <li>Count backwards from 10 to 0.</li>
                    <li>Complete the number sentence: 5 + __ = 10.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_NumberBonds10_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download number bonds to 10 worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Use two different colors of blocks to make a tower of 10 and see the number bonds.
                </div>
                <div class="info-box">
                    Number bonds are like a number family.
                </div>
                <div class="info-box">
                    Knowing your number bonds to 10 will make you a maths superstar!
                </div>
            </div>
