...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 4</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 4</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Numbers 1, 2, 3</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we begin our journey with numbers! We will focus on recognizing, counting, and writing the numbers 1, 2, and 3.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Count objects up to 3. Practice writing the numerals 1, 2, and 3. Match the numeral to the correct number of objects.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Numbers 1, 2, and 3</h3>
                <p>Numbers help us count how many things there are.</p>
                <ul>
                    <li>One (1)</li>
                    <li>Two (2)</li>
                    <li>Three (3)</li>
                ...
                <h4>🔹 Counting</h4>
                <p>Count objects you see around you.</p>
                <p>Examples:</p>
                <ul>
                    <li>1 nose</li>
                    <li>2 eyes</li>
                    <li>3 buttons on a coat</li>
                </ul>

                <h4>🔹 Writing Numerals</h4>
                <p>Practice tracing and writing the numbers. Remember the rhymes!</p>
                <ul>
                    <li>1: A straight line down.</li>
                    <li>2: Around and back on the railway track.</li>
                    <li>3: Around a tree, around a tree.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>How many wheels on a tricycle? (3)</li>
                    <li>Draw 2 circles.</li>
                    <li>Show me 1 finger.</li>
                    <li>Find 3 red things in the room.</li>
                    <li>Write the numbers 1, 2, 3.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Numbers123_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download numbers 1, 2, 3 worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Counting is fun! Count your toys, your snacks, and your steps.
                </div>
                <div class="info-box">
                    Look for numbers on doors, buses, and in books.
                </div>
                <div class="info-box">
                    Practice writing numbers in sand, with paint, or on a whiteboard.
                </div>
            </div>
