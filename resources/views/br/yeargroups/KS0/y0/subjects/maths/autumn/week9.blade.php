...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 9</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 9</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Numbers 6, 7, 8</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>Let's continue our number journey! This week we will explore the numbers 6, 7, and 8.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Count objects up to 8. Practice writing the numerals 6, 7, and 8. Find things that come in groups of 6, 7, or 8.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Numbers 6, 7, and 8</h3>
                <p>We can find these numbers in the world around us.</p>
                <ul>
                    <li>Six (6): An insect has 6 legs.</li>
                    <li>Seven (7): A rainbow has 7 colours.</li>
                    <li>Eight (8): A spider has 8 legs.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Draw a ladybug with 6 spots.</li>
                    <li>Can you name the 7 days of the week?</li>
                    <li>Draw an octopus with 8 legs.</li>
                    <li>Count out 7 blocks from a pile.</li>
                    <li>Write the numbers 6, 7, 8.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Numbers678_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download numbers 6, 7, 8 worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Look at an egg box - it often has 6 spaces.
                </div>
                <div class="info-box">
                    The story of Snow White has seven dwarfs.
                </div>
                <div class="info-box">
