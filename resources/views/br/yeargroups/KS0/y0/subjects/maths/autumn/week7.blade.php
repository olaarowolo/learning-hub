...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 7</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 7</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: One More, One Less</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we will learn about finding 'one more' and 'one less' than a number up to 5. This is an important step in understanding number relationships.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Use objects to add one more or take one away. Sing songs like "Five Little Ducks".</p>
            </div>
            <div class="assessment-details">
                <h3>📊 One More, One Less</h3>
                <p>'One more' means adding one. 'One less' means taking one away.</p>
                <ul>
                    <li>One more than 3 is 4.</li>
                    <li>One less than 3 is 2.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>What is one more than 3? (4)</li>
                    <li>What is one less than 5? (4)</li>
                    <li>If you have 2 sweets and get one more, how many do you have? (3)</li>
                    <li>There are 4 birds on a branch. One flies away. How many are left? (3)</li>
                    <li>Use blocks to show one more than 2.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_OneMoreLess_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download one more, one less worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Use a number line to help you see one more and one less.
                </div>
                <div class="info-box">
                    'More' means the number gets bigger. 'Less' means the number gets smaller.
                </div>
                <div class="info-box">
                    Play games where you add or remove one object from a group.
                </div>
            </div>
