...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 3</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 3</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Comparing Size and Mass</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we will explore the concepts of size and mass. Children will learn to compare objects and use language like 'bigger', 'smaller', 'heavier', and 'lighter'.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Practice comparing everyday objects. Use a balance scale to compare the mass of different items.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Comparing Size and Mass</h3>
                <p>Size is how big or small something is. Mass is how heavy it is. We can use words like big, small, long, short, tall, heavy, and light.</p>

                <h4>🔹 Comparing Size</h4>
                <p>Look at two objects and decide which is bigger or smaller.</p>
                <p>Examples:</p>
                <ul>
                    <li>A bus is bigger than a car.</li>
                    <li>An apple is smaller than a watermelon.</li>
                </ul>

                <h4>🔹 Comparing Mass</h4>
                <p>Hold two objects to feel which is heavier or lighter. You can use a balance scale to check.</p>
                <p>Examples:</p>
                <ul>
                    <li>A book is heavier than a pencil.</li>
                    <li>A feather is lighter than a stone.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Find something bigger than your hand.</li>
                    <li>Find something smaller than your shoe.</li>
                    <li>Which is heavier, a toy car or a teddy bear?</li>
                    <li>Which is lighter, a leaf or a rock?</li>
                    <li>Order three different-sized balls from smallest to largest.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Size_Mass_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download size and mass worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    You can compare the size of anything!
                </div>
                <div class="info-box">
                    Heavier things are not always bigger.
                </div>
                <div class="info-box">
                    Use your hands as a balance scale to feel the difference.
                </div>
            </div>
