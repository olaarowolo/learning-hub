...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 5</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 5</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Number 4</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week we will learn about the number 4. We will practice counting, recognizing, and writing the number 4.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Find groups of 4 objects. Draw pictures with 4 things. Practice writing the numeral 4.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Number 4</h3>
                <p>The number four (4) comes after three. Many things come in groups of four.</p>
                <ul>
                    <li>A square has 4 sides.</li>
                    <li>A car has 4 wheels.</li>
                    <li>A table often has 4 legs.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Draw a square.</li>
                    <li>How many legs does a cat have? (4)</li>
                    <li>Show me 4 fingers.</li>
                    <li>Find 4 blue things in the room.</li>
                    <li>Write the number 4.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Number4_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download number 4 worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Look for squares and rectangles around you - they all have 4 sides!
                </div>
                <div class="info-box">
                    Count the legs on animals like dogs, cats, and lions.
                </div>
                <div class="info-box">
                    Practice writing the number 4: down and over, and down once more.
                </div>
            </div>
