...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 8</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 8</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Positional Language</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week, we will learn words to describe where things are. This helps us give and follow directions and describe the world around us.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Play "Simon Says" using positional words. Describe the position of objects in the classroom. Build with blocks and describe where you are putting them.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Positional Language</h3>
                <p>We use special words to say where things are.</p>
                <ul>
                    <li>On, under, next to</li>
                    <li>Behind, in front of</li>
                    <li>Between, above, below</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Put your book on the table.</li>
                    <li>Stand behind your chair.</li>
                    <li>What is next to the window?</li>
                    <li>Hide a toy under a cushion.</li>
                    <li>Place a pencil between two books.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Position_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download positional language worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Play hide-and-seek and describe where you are hiding.
                </div>
                <div class="info-box">
                    Follow instructions to build an obstacle course and describe how to get through it.
                </div>
                <div class="info-box">
                    Look at picture books and describe where characters and objects are on the page.
                </div>
            </div>
