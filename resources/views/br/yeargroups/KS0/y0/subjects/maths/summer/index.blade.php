...
<body>
    <header class="year-header">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <a href="{{ route('home') }}">Home</a> > <span>Year Groups</span> > <span>KS0</span> > <span>Year 0</span> > <span>Maths</span> > <span>Summer Term</span>
        </nav>
        <h1>Year 0 Mathematics - Summer Term</h1>
