...
<head>
    ...
    <title>Year 0 Maths Autumn Term - Week 6</title>
...
<body>
    <header class="year-header">
        <h1>Year 0 Maths Autumn Term - Week 6</h1>
        <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/index.html" class="back-link">&larr; Back to Autumn Term</a>
    </header>
    <div class="container">
        <main>
            <h2>Topic: Number 5</h2>
            <div class="content-section">
                <h3>Introduction</h3>
                <p>This week is all about the number 5! We will count up to 5, recognize the numeral, and find 5 in the world around us.</p>
            </div>
            <div class="content-section">
                <h3>Tasks</h3>
                <p>Count fingers on one hand. Make groups of 5. Practice writing the numeral 5.</p>
            </div>
            <div class="assessment-details">
                <h3>📊 Number 5</h3>
                <p>The number five (5) is a fun number. We see it in many places.</p>
                <ul>
                    <li>A star has 5 points.</li>
                    <li>We have 5 fingers on one hand.</li>
                    <li>We have 5 toes on one foot.</li>
                </ul>

                <h3>📝 Practice Exercises</h3>
                <ol class="question-list">
                    <li>Draw a star with 5 points.</li>
                    <li>Count your fingers on one hand.</li>
                    <li>Give a friend a 'high five'.</li>
                    <li>Find 5 different colored crayons.</li>
                    <li>Write the number 5.</li>
                </ol>
            </div>
            <div class="download-links">
                <a href="/data/yeargroups/KS0/y0/subjects/maths/autumn/Year0_Autumn_Number5_Worksheet.pdf" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    <span>Download number 5 worksheet</span>
                </a>
            ...
            <div class="info-container">
                <div class="info-box">
                    Sing "Five Little Ducks" to practice counting down from 5.
                </div>
                <div class="info-box">
                    Look for pentagons, which are shapes with 5 sides.
                </div>
                <div class="info-box">
                    Practice writing the number 5: a short neck, belly fat, number 5 wears a hat.
                </div>
            </div>
